...
// Back Top Legs
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THIN_SHORT_1, back_leg_top_thin_short_1::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THIN_SHORT_2, back_leg_top_thin_short_2::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THIN_AVERAGE_1, back_leg_top_thin_average_1::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THIN_AVERAGE_2, back_leg_top_thin_average_2::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THIN_LONG_1, back_leg_top_thin_long_1::createBodyLayer);
        ...
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THICK_SHORT_1, back_leg_top_thick_short_1::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THICK_SHORT_2, back_leg_top_thick_short_2::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THICK_AVERAGE_1, back_leg_top_thick_average_1::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THICK_AVERAGE_2, back_leg_top_thick_average_2::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THICK_LONG_1, back_leg_top_thick_long_1::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.BACK_LEG_TOP_THICK_LONG_2, back_leg_top_thick_long_2::createBodyLayer);
