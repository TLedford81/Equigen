...
public class stomach_muscular_long_low extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition stomach_muscular_long_low_stomach_front_upper = stomach_muscular_long_low.addOrReplaceChild("stomach_muscular_long_low_stomach_front_upper", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -3.0223F));
		...
		PartDefinition cube_r1 = stomach_muscular_long_low_stomach_front_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(60, 78).addBox(-6.0892F, -4.2676F, -5.4648F, 7.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5892F, -2.9648F, 0.7676F, 1.5708F, 0.0F, 0.0F));

		PartDefinition stomach_muscular_long_low_stomach_front_lower = stomach_muscular_long_low_stomach_front_upper.addOrReplaceChild("stomach_muscular_long_low_stomach_front_lower", CubeListBuilder.create(), PartPose.offset(-0.0495F, -0.5018F, -0.9428F));

		PartDefinition cube_r2 = stomach_muscular_long_low_stomach_front_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(84, 78).addBox(-5.08F, -5.24F, -5.52F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -3.02F, 1.74F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = stomach_muscular_long_low_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(40, 101).addBox(-7.0984F, -6.2952F, -5.4096F, 7.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5984F, -3.4091F, -0.3014F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_muscular_long_low_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(42, 84).addBox(-5.08F, -6.24F, -5.52F, 5.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -3.5082F, -0.3749F, 1.7453F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart stomach = this.stomach_muscular_long_low;

		registerAnchorPath("backAnchor", root, stomach, this.backAnchor);
	}
	@Override
	public Part getCubeDimensions() {
		return new Part("stomach_muscular_long_low", new ArrayList<>(
				Arrays.asList(
						new Block(7, 7, 5),
						new Block(5, 7, 5),
						new Block(7, 13, 4),
