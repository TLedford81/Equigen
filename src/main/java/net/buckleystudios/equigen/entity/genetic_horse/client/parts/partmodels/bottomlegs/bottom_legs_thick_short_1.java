...
public class bottom_legs_thick_short_1 extends MultipartBottomLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer(GeneticValues.LEG leg) {
		...
		PartDefinition cube_r1 = bottom_legs_thick_short_1_bottom_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(uvXOffset, uvYOffset).addBox(-1.0189F, -1.1115F, -1.7977F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0188F, -0.7977F, 0.1115F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = bottom_legs_thick_short_1_bottom_lower_individual.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(uvXOffset, uvYOffset).addBox(-0.9811F, -1.4237F, -1.9046F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0188F, -0.5353F, 0.8434F, 1.0036F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart bottom_legs = this.bottom_legs_thick_short_1;
	...
	public Part getCubeDimensions() {
		return new Part("bottom_legs_thick_short_1", new ArrayList<>(
				Arrays.asList(
						new Block(2, 2, 2),
						new Block(2, 2, 2))
		));
