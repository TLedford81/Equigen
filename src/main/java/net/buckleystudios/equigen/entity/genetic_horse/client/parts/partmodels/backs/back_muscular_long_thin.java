...
public class back_muscular_long_thin extends MultipartBackModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_muscular_long_thin_back_ribs = back_muscular_long_thin.addOrReplaceChild("back_muscular_long_thin_back_ribs", CubeListBuilder.create().texOffs(33, 3).addBox(-4.0F, -3.1397F, -6.5F, 8.0F, 6.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0429F, 0.1397F, 0.0547F));
		...
		PartDefinition cube_r1 = back_muscular_long_thin_back_top_lower_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 1).addBox(-6.08F, -7.24F, -4.52F, 7.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -2.2075F, 2.0554F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = back_muscular_long_thin_back_top_upper.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 18).addBox(-4.08F, -7.24F, -5.52F, 4.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -2.7056F, 2.0118F, 1.6581F, 0.0F, 0.0F));

		PartDefinition chestAnchor = back_muscular_long_thin.addOrReplaceChild("chestAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, -6.25F));

		PartDefinition hipsAnchor = back_muscular_long_thin.addOrReplaceChild("hipsAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 6.75F));

		PartDefinition stomachAnchor = back_muscular_long_thin.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 7.5F));

		PartDefinition withersAnchor = back_muscular_long_thin.addOrReplaceChild("withersAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, -6.25F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart back = this.back_muscular_long_thin;
	...
	public Part getCubeDimensions() {
		return new Part("back_muscular_long_thin", new ArrayList<>(
				Arrays.asList(
						new Block(8, 6, 13),
						new Block(7, 10, 5),
						new Block(4, 10, 6))
