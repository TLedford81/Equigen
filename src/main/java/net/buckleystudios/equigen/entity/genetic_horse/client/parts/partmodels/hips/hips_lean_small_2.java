...
public class hips_lean_small_2 extends MultipartHipModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hips_lean_small_2_left_hip_glute_outer = hips_lean_small_2_left_hip_glute_base.addOrReplaceChild("hips_lean_small_2_left_hip_glute_outer", CubeListBuilder.create().texOffs(0, 93).addBox(-2.0F, -2.5F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(2.3799F, -0.1257F, -0.0342F));
		...
		PartDefinition hips_lean_small_2_right_hip_glue_outer = hips_lean_small_2_right_hip_glute_base.addOrReplaceChild("hips_lean_small_2_right_hip_glue_outer", CubeListBuilder.create().texOffs(0, 106).addBox(-2.0F, -2.5F, -2.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.6201F, 0.1425F, -0.0342F));

		PartDefinition hips_lean_small_2_hips_top = hips_lean_small_2.addOrReplaceChild("hips_lean_small_2_hips_top", CubeListBuilder.create(), PartPose.offset(-0.3575F, -1.2082F, 1.0726F));
		...
		PartDefinition cube_r1 = hips_lean_small_2_hips_top_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 70).addBox(-4.1694F, -5.24F, -4.36F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1694F, -0.3699F, 4.1182F, 1.1781F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = hips_lean_small_2_hips_top_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 81).addBox(-5.1694F, -4.909F, -6.3143F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1694F, -2.1402F, 3.4939F, 1.1781F, 0.0F, 0.0F));
	...
	public Part getCubeDimensions() {
		return new Part("hips_lean_small_2", new ArrayList<>(
				Arrays.asList(
						new Block(4, 7, 6),
						new Block(4, 5, 5),
						new Block(4, 7, 6),
