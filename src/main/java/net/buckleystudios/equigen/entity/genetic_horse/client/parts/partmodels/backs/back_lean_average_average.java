...
public class back_lean_average_average extends MultipartBackModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_lean_average_average_back_ribs = back_lean_average_average.addOrReplaceChild("back_lean_average_average_back_ribs", CubeListBuilder.create().texOffs(33, 4).addBox(-3.0F, -3.4246F, -6.0F, 6.0F, 7.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.0297F, -0.0754F, 0.0184F));
		...
		PartDefinition cube_r1 = back_lean_average_average_back_top_lower_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 0).addBox(-4.08F, -6.24F, -5.52F, 5.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, -2.6621F, 1.5137F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = back_lean_average_average_back_top_upper.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 17).addBox(-4.08F, -6.24F, -6.52F, 4.0F, 9.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.1602F, 1.4702F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition stomachAnchor = back_lean_average_average.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.5F, 7.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart back = this.back_lean_average_average;
	...
	public Part getCubeDimensions() {
		return new Part("back_lean_average_average", new ArrayList<>(
				Arrays.asList(
						new Block(6, 7, 12),
						new Block(5, 9, 6),
						new Block(4, 9, 7))
