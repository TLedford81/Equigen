...
//            Map<GeneticValues, Float> renderGenetics = GeneticsHandler.getRenderGenetics(entity);
    ...
    private Map<String, MultipartModel<GeneticHorseEntity>> createModelMap(GeneticHorseEntity entity) {
        ...
        modelMap.put("topFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopFrontLegKey(entity), modelSet));
        modelMap.put("kneeFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet));
        modelMap.put("bottomFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet));
        modelMap.put("hoofFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet));
        modelMap.put("topFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopFrontLegKey(entity), modelSet));
        modelMap.put("kneeFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet));
        modelMap.put("bottomFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet));
        modelMap.put("hoofFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet));
        ...
        modelMap.put("topBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopBackLegKey(entity), modelSet));
        modelMap.put("kneeBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet));
        modelMap.put("bottomBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet));
        modelMap.put("hoofBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet));
        modelMap.put("topBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopBackLegKey(entity), modelSet));
        modelMap.put("kneeBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet));
        modelMap.put("bottomBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet));
        modelMap.put("hoofBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet));
