...
//            Map<GeneticValues, Float> renderGenetics = GeneticsHandler.getRenderGenetics(entity);
    ...
    private Map<String, MultipartModel<GeneticHorseEntity>> createModelMap(GeneticHorseEntity entity) {
        ...
        modelMap.put("headModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHeadKey(entity), modelSet));
        modelMap.put("leftEarModel", ModelPartRegistry.getModel(RegistryKeyFactory.getLeftEarKey(entity), modelSet));
        modelMap.put("rightEarModel", ModelPartRegistry.getModel(RegistryKeyFactory.getRightEarKey(entity), modelSet));
        modelMap.put("topFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopFrontLegKey(entity), modelSet, GeneticValues.LEG.FRONT_LEFT));
        modelMap.put("kneeFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet, GeneticValues.LEG.FRONT_LEFT));
        modelMap.put("bottomFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet, GeneticValues.LEG.FRONT_LEFT));
        modelMap.put("hoofFrontLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet, GeneticValues.LEG.FRONT_LEFT));
        modelMap.put("topFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopFrontLegKey(entity), modelSet, GeneticValues.LEG.FRONT_RIGHT));
        modelMap.put("kneeFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet, GeneticValues.LEG.FRONT_RIGHT));
        modelMap.put("bottomFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet, GeneticValues.LEG.FRONT_RIGHT));
        modelMap.put("hoofFrontRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet, GeneticValues.LEG.FRONT_RIGHT));
        modelMap.put("hipsModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHipKey(entity), modelSet));
        modelMap.put("tailModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTailKey(entity), modelSet));
        modelMap.put("topBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopBackLegKey(entity), modelSet, GeneticValues.LEG.BACK_LEFT));
        modelMap.put("kneeBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet, GeneticValues.LEG.BACK_LEFT));
        modelMap.put("bottomBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet, GeneticValues.LEG.BACK_LEFT));
        modelMap.put("hoofBackLeftLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet, GeneticValues.LEG.BACK_LEFT));
        modelMap.put("topBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getTopBackLegKey(entity), modelSet, GeneticValues.LEG.BACK_RIGHT));
        modelMap.put("kneeBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getKneeKey(entity), modelSet, GeneticValues.LEG.BACK_RIGHT));
        modelMap.put("bottomBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getBottomLegKey(entity), modelSet, GeneticValues.LEG.BACK_RIGHT));
        modelMap.put("hoofBackRightLegModel", ModelPartRegistry.getModel(RegistryKeyFactory.getHoofKey(entity), modelSet, GeneticValues.LEG.BACK_RIGHT));
        modelMap.put("withersModel", ModelPartRegistry.getModel(RegistryKeyFactory.getWitherKey(entity), modelSet));
        modelMap.put("stomachModel", ModelPartRegistry.getModel(RegistryKeyFactory.getStomachKey(entity), modelSet));
        return modelMap;
    }
