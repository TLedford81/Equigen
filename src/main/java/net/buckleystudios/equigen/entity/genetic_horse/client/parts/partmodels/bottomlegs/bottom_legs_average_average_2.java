...
public class bottom_legs_average_average_2 extends MultipartBottomLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bottom_legs_average_average_2_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 154).addBox(-0.9829F, -0.4691F, -3.8368F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0171F, -1.8368F, -0.0309F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = bottom_legs_average_average_2_lower_individual.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(18, 137).addBox(-1.0171F, -0.4825F, -4.0133F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0171F, -1.8321F, 0.835F, 1.1345F, 0.0F, 0.0F));
	...
	public Part getCubeDimensions() {
		return new Part("bottom_legs_average_average_2", new ArrayList<>(
				Arrays.asList(
						new Block(2, 1, 4),
						new Block(2, 1, 4))
		));
