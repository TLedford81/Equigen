...
public class top_back_legs_average_short_1 extends MultipartBackTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = top_back_legs_average_short_1_top_back_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(35, 126).mirror().addBox(-1.055F, -2.0F, -1.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.055F, 1.4651F, 1.6892F, 1.9635F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_back_legs_average_short_1_top_back_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(49, 122).mirror().addBox(-0.945F, -2.0F, 0.08F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.055F, 3.4841F, 0.963F, 1.7017F, 0.0F, 0.0F));
