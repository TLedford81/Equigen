...
public class top_back_legs_average_short_2 extends MultipartBackTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = top_back_legs_average_short_2_top_back_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(35, 125).mirror().addBox(-1.055F, -2.0F, -1.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.055F, 1.927F, 1.8806F, 1.9635F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_back_legs_average_short_2_top_back_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(49, 121).mirror().addBox(-0.945F, -2.0F, 0.08F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.055F, 3.9798F, 1.0283F, 1.7017F, 0.0F, 0.0F));
