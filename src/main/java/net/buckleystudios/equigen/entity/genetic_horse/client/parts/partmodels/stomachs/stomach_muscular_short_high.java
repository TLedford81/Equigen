...
public class stomach_muscular_short_high extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = stomach_muscular_short_high_stomach_front_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(60, 79).addBox(-6.0892F, -2.2676F, -5.4648F, 7.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5892F, -3.4648F, -3.2324F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = stomach_muscular_short_high_stomach_front_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(84, 79).addBox(-5.08F, -3.24F, -5.52F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -3.52F, -2.26F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = stomach_muscular_short_high_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(40, 101).addBox(-7.0984F, -0.2952F, -5.4096F, 7.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5984F, -2.8881F, -3.2558F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_muscular_short_high_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(42, 84).addBox(-5.08F, -0.24F, -5.52F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -2.9872F, -3.3293F, 1.7453F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart stomach = this.stomach_muscular_short_high;

		registerAnchorPath("backAnchor", root, stomach, this.backAnchor);
	}
	@Override
	public Part getCubeDimensions() {
		return new Part("stomach_muscular_short_high", new ArrayList<>(
				Arrays.asList(
						new Block(7, 12, 4),
						new Block(5, 12, 4),
						new Block(7, 6, 4),
