...
public class top_front_legs_average_long_2 extends MultipartFrontTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = top_front_legs_average_long_2_top_front_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(42, 65).addBox(-1.1442F, -2.0F, -2.02F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1442F, 2.6929F, 1.6213F, 1.789F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_front_legs_average_long_2_top_front_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(23, 111).mirror().addBox(-0.8132F, -2.0F, -1.84F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1868F, 2.7678F, 0.6442F, 1.4399F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = top_front_legs_average_long_2_top_front_middle.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(18, 100).addBox(-1.1949F, -2.0F, -0.8316F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1949F, 3.6684F, 1.0F, 1.5708F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart top_front_legs = this.top_front_legs_average_long_2;
	...
	public Part getCubeDimensions() {
		return new Part("top_front_legs_average_long_2", new ArrayList<>(
				Arrays.asList(
						new Block(2, 2, 10),
						new Block(2, 2, 9),
						new Block(2, 2, 9))
