...
public class top_front_legs_average_long_1 extends MultipartFrontTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer(GeneticValues.LEG leg) {
		...
		PartDefinition top_front_legs_average_long_1_top_front_front = top_front_legs_average_long_1.addOrReplaceChild("top_front_legs_average_long_1_top_front_front", CubeListBuilder.create(), PartPose.offset(-0.1442F, 3.6942F, -0.4677F));

		PartDefinition cube_r1 = top_front_legs_average_long_1_top_front_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(uvXOffset, uvYOffset).mirror().addBox(-1.1442F, -2.0F, -0.02F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1442F, 4.1574F, 1.9459F, 1.789F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_front_legs_average_long_1_top_front_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(uvXOffset, uvYOffset).mirror().addBox(-0.8132F, -2.0F, -0.84F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1868F, 3.2635F, 0.579F, 1.4399F, 0.0F, 0.0F));

		PartDefinition top_front_legs_average_long_1_top_front_middle = top_front_legs_average_long_1.addOrReplaceChild("top_front_legs_average_long_1_top_front_middle", CubeListBuilder.create(), PartPose.offset(0.1949F, 3.6774F, 0.4813F));

		PartDefinition cube_r3 = top_front_legs_average_long_1_top_front_middle.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(uvXOffset, uvYOffset).mirror().addBox(-0.8051F, -2.0F, -0.8316F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1949F, 3.1684F, 1.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition chestAnchor = top_front_legs_average_long_1.addOrReplaceChild("chestAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.4F, -2.1F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart top_front_legs = this.top_front_legs_average_long_1;
