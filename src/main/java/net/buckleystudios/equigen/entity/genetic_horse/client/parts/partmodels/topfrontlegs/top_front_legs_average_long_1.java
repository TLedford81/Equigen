...
public class top_front_legs_average_long_1 extends MultipartFrontTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = top_front_legs_average_long_1_top_front_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(42, 66).mirror().addBox(-1.1442F, -2.0F, -0.02F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1442F, 4.1574F, 1.9459F, 1.789F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_front_legs_average_long_1_top_front_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(23, 112).mirror().addBox(-0.8132F, -2.0F, -0.84F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1868F, 3.2635F, 0.579F, 1.4399F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = top_front_legs_average_long_1_top_front_middle.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(18, 101).mirror().addBox(-0.8051F, -2.0F, -0.8316F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1949F, 3.1684F, 1.0F, 1.5708F, 0.0F, 0.0F));
