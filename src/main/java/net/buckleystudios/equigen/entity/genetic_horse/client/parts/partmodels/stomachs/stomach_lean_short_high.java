...
public class stomach_lean_short_high extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition stomach_lean_short_high_stomach_front_upper = stomach_lean_short_high.addOrReplaceChild("stomach_lean_short_high_stomach_front_upper", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -4.0224F));
		...
		PartDefinition cube_r1 = stomach_lean_short_high_stomach_front_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(60, 79).addBox(-4.0892F, -2.2676F, -5.4648F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5892F, -3.4648F, -3.2324F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = stomach_lean_short_high_stomach_front_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(84, 79).addBox(-4.08F, -3.24F, -5.52F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.52F, -2.26F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = stomach_lean_short_high_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(40, 101).addBox(-5.0984F, -0.2952F, -5.4096F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5984F, -2.8881F, -3.2558F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_lean_short_high_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(42, 84).addBox(-4.0792F, -0.2976F, -5.4648F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0792F, -2.9429F, -3.263F, 1.7453F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart stomach = this.stomach_lean_short_high;

		registerAnchorPath("backAnchor", root, stomach, this.backAnchor);
	}
	@Override
	public Part getCubeDimensions() {
		return new Part("stomach_lean_short_high", new ArrayList<>(
				Arrays.asList(
						new Block(5, 12, 4),
						new Block(4, 12, 4),
						new Block(5, 6, 4),
