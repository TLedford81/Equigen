...
public class chest_lean_large_1 extends MultipartChestModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = chest_lean_large_1_chest_front_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(30, 137).addBox(-3.08F, -7.68F, -4.52F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, -2.02F, 5.68F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = chest_lean_large_1_chest_front_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(59, 132).addBox(-3.0792F, -7.6432F, -3.4848F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5792F, -3.3253F, 4.795F, 1.9199F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = chest_lean_large_1_chest_left_pectoral_top.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(91, 141).addBox(-2.0892F, -3.98F, -0.9108F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5892F, 1.2102F, -2.9329F, -0.829F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = chest_lean_large_1_chest_left_pectoral_middle.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(111, 131).addBox(-0.5F, -2.0F, -2.5F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = chest_lean_large_1_chest_left_pectoral_bottom.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(75, 132).addBox(-2.08F, -7.68F, -4.52F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.58F, -3.8409F, 4.6466F, 1.9199F, 0.0F, 0.0F));
		...
		PartDefinition chest_lean_large_1_chest_left_deltoid_outer = chest_lean_large_1_chest_left_deltoid.addOrReplaceChild("chest_lean_large_1_chest_left_deltoid_outer", CubeListBuilder.create().texOffs(48, 147).addBox(-2.0F, -3.5F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0559F, -0.1983F, 0.1976F));

		PartDefinition chest_lean_large_1_chest_left_deltoid_base = chest_lean_large_1_chest_left_deltoid.addOrReplaceChild("chest_lean_large_1_chest_left_deltoid_base", CubeListBuilder.create().texOffs(100, 142).addBox(-2.0F, -4.5F, -4.5F, 4.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5028F, -0.0028F, 0.1781F));
		...
		PartDefinition cube_r6 = chest_lean_large_1_chest_right_pectoral_top.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(64, 140).addBox(-4.08F, -4.0F, -0.92F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 1.2305F, -2.9415F, -0.829F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = chest_lean_large_1_chest_right_pectoral_middle.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(91, 131).addBox(-2.505F, -2.02F, -2.475F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.005F, 0.025F, 0.02F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = chest_lean_large_1_chest_right_pectoral_bottom.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(48, 137).addBox(-4.0692F, -7.6432F, -4.4748F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5692F, -3.7858F, 4.6274F, 1.9199F, 0.0F, 0.0F));
		...
		PartDefinition chest_lean_large_1_chest_right_deltoid_outer = chest_lean_large_1_chest_right_deltoid.addOrReplaceChild("chest_lean_large_1_chest_right_deltoid_outer", CubeListBuilder.create().texOffs(24, 147).addBox(-2.0F, -3.5F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.9441F, -0.1983F, 0.1976F));

		PartDefinition chest_lean_large_1_chest_right_deltoid_base = chest_lean_large_1_chest_right_deltoid.addOrReplaceChild("chest_lean_large_1_chest_right_deltoid_base", CubeListBuilder.create().texOffs(72, 142).addBox(-2.0F, -4.5F, -4.5F, 4.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5022F, -0.0478F, 0.2213F));
		...
		PartDefinition frontLeftLegAnchor = chest_lean_large_1.addOrReplaceChild("frontLeftLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.25F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.75F, 4.5F, -3.3212F));

		PartDefinition frontRightLegAnchor = chest_lean_large_1.addOrReplaceChild("frontRightLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.25F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.75F, 4.5F, -3.3212F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart chest = this.chest_lean_large_1;
	...
	public Part getCubeDimensions() {
		return new Part("chest_lean_large_1", new ArrayList<>(
				Arrays.asList(
						new Block(3, 4, 5),
						new Block(3, 4, 4),
						new Block(3, 2, 4),
