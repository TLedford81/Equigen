...
public class top_front_legs_thick_average_2 extends MultipartFrontTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = top_front_legs_thick_average_2_top_front_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(42, 67).mirror().addBox(-1.1889F, -2.0F, -2.02F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1889F, 1.7166F, 1.4049F, 1.789F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_front_legs_thick_average_2_top_front_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(23, 113).mirror().addBox(-0.7685F, -3.0F, -1.84F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.2315F, 1.7239F, 1.4262F, 1.5272F, 0.0F, 0.0F));
	...
	public Part getCubeDimensions() {
		return new Part("top_front_legs_thick_average_2", new ArrayList<>(
				Arrays.asList(
						new Block(2, 2, 8),
						new Block(2, 3, 7),
						new Block(0, 0, 0))
