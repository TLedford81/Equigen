...
public class hips_muscular_large_2 extends MultipartHipModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hips_muscular_large_2_left_hip_glute_base_individual = hips_muscular_large_2_left_hip_glute_base.addOrReplaceChild("hips_muscular_large_2_left_hip_glute_base_individual", CubeListBuilder.create().texOffs(0, 118).addBox(-2.5F, -4.5F, -4.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(2.6491F, -0.2413F, -0.1017F));

		PartDefinition hips_muscular_large_2_left_hip_glute_outer = hips_muscular_large_2_left_hip_glute_base.addOrReplaceChild("hips_muscular_large_2_left_hip_glute_outer", CubeListBuilder.create().texOffs(0, 92).addBox(-2.5F, -3.5F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(3.1648F, -0.3045F, -0.0705F));
		...
		PartDefinition hips_muscular_large_2_right_hip_glue_base_individual = hips_muscular_large_2_right_hip_glute_base.addOrReplaceChild("hips_muscular_large_2_right_hip_glue_base_individual", CubeListBuilder.create().texOffs(0, 135).addBox(-2.5F, -4.5F, -4.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.2989F, -0.1983F, -0.1431F));

		PartDefinition hips_muscular_large_2_right_hip_glue_outer = hips_muscular_large_2_right_hip_glute_base.addOrReplaceChild("hips_muscular_large_2_right_hip_glue_outer", CubeListBuilder.create().texOffs(0, 105).addBox(-2.5F, -3.5F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.8352F, -0.3045F, -0.0705F));
		...
		PartDefinition cube_r1 = hips_muscular_large_2_hips_top_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 67).addBox(-5.08F, -4.24F, -7.36F, 5.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -2.3912F, 3.2541F, 1.2217F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = hips_muscular_large_2_hips_top_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 79).addBox(-6.08F, -4.24F, -7.36F, 7.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -2.5623F, 2.7843F, 1.2217F, 0.0F, 0.0F));

		PartDefinition backAnchor = hips_muscular_large_2.addOrReplaceChild("backAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.775F, 0.4469F));

		PartDefinition tailAnchor = hips_muscular_large_2.addOrReplaceChild("tailAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.1F, -3.5F, 3.6969F));

		PartDefinition backLeftLegAnchor = hips_muscular_large_2.addOrReplaceChild("backLeftLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(3.75F, 4.25F, 1.4469F));

		PartDefinition backRightLegAnchor = hips_muscular_large_2.addOrReplaceChild("backRightLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.75F, 4.25F, 1.4469F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart hips = this.hips_muscular_large_2;
	...
	public Part getCubeDimensions() {
		return new Part("hips_muscular_large_2", new ArrayList<>(
				Arrays.asList(
						new Block(5, 9, 8),
						new Block(5, 7, 6),
						new Block(5, 9, 8),
