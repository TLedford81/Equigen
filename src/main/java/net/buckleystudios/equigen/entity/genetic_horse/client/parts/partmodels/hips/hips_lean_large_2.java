...
public class hips_lean_large_2 extends MultipartHipModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hips_lean_large_2 = partdefinition.addOrReplaceChild("hips_lean_large_2", CubeListBuilder.create(), PartPose.offset(-0.7151F, 23.75F, -0.5363F));
		...
		PartDefinition hips_lean_large_2_left_hip_glute_base_individual = hips_lean_large_2_left_hip_glute_base.addOrReplaceChild("hips_lean_large_2_left_hip_glute_base_individual", CubeListBuilder.create().texOffs(0, 118).addBox(-2.4312F, -4.457F, -4.0414F, 4.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(2.6491F, 0.295F, -0.1017F));

		PartDefinition hips_lean_large_2_left_hip_glute_outer = hips_lean_large_2_left_hip_glute_base.addOrReplaceChild("hips_lean_large_2_left_hip_glute_outer", CubeListBuilder.create().texOffs(0, 92).addBox(-2.0F, -3.5F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(2.6816F, 0.2318F, -0.0705F));
		...
		PartDefinition hips_lean_large_2_right_hip_glue_base_individual = hips_lean_large_2_right_hip_glute_base.addOrReplaceChild("hips_lean_large_2_right_hip_glue_base_individual", CubeListBuilder.create().texOffs(0, 135).addBox(-2.0F, -4.5F, -4.0F, 4.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.7943F, 0.295F, -0.1017F));

		PartDefinition hips_lean_large_2_right_hip_glue_outer = hips_lean_large_2_right_hip_glute_base.addOrReplaceChild("hips_lean_large_2_right_hip_glue_outer", CubeListBuilder.create().texOffs(0, 105).addBox(-2.0F, -3.5F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.3184F, 0.2318F, -0.0705F));
		...
		PartDefinition cube_r1 = hips_lean_large_2_hips_top_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 67).addBox(-4.08F, -4.24F, -7.36F, 4.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -2.3912F, 3.2541F, 1.2217F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = hips_lean_large_2_hips_top_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 79).addBox(-5.08F, -4.24F, -7.36F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -2.5623F, 2.7843F, 1.2217F, 0.0F, 0.0F));

		PartDefinition backAnchor = hips_lean_large_2.addOrReplaceChild("backAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.7151F, -4.175F, 0.5363F));
		...
		PartDefinition backLeftLegAnchor = hips_lean_large_2.addOrReplaceChild("backLeftLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(3.4651F, 4.85F, 1.5363F));

		PartDefinition backRightLegAnchor = hips_lean_large_2.addOrReplaceChild("backRightLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0349F, 4.85F, 1.5363F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart hips = this.hips_lean_large_2;
	...
	public Part getCubeDimensions() {
		return new Part("hips_lean_large_2", new ArrayList<>(
				Arrays.asList(
						new Block(4, 9, 8),
						new Block(4, 7, 6),
						new Block(4, 9, 8),
