...
public class back_muscular_average_thin extends MultipartBackModel<GeneticHorseEntity> {
	...
	public back_muscular_average_thin(ModelPart root) {
		...
		this.playerAnchor = this.back_muscular_average_thin.getChild("playerAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_muscular_average_thin_back_ribs = back_muscular_average_thin.addOrReplaceChild("back_muscular_average_thin_back_ribs", CubeListBuilder.create().texOffs(33, 4).addBox(-4.0F, -3.1397F, -6.0F, 8.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.0465F, 0.1397F, 0.0184F));
		...
		PartDefinition cube_r1 = back_muscular_average_thin_back_top_lower_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 1).addBox(-6.08F, -6.24F, -4.52F, 7.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -2.164F, 1.5573F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = back_muscular_average_thin_back_top_upper.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 18).addBox(-4.08F, -6.24F, -5.52F, 4.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -2.6621F, 1.5137F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition stomachAnchor = back_muscular_average_thin.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 6.9F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart back = this.back_muscular_average_thin;
	...
	public Part getCubeDimensions() {
		return new Part("back_muscular_average_thin", new ArrayList<>(
				Arrays.asList(
						new Block(8, 6, 12),
						new Block(7, 9, 5),
						new Block(4, 9, 6))
