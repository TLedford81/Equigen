...
public class back_muscular_average_average extends MultipartBackModel<GeneticHorseEntity> {
	...
	public back_muscular_average_average(ModelPart root) {
		...
		this.playerAnchor = this.back_muscular_average_average.getChild("playerAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_muscular_average_average_back_ribs = back_muscular_average_average.addOrReplaceChild("back_muscular_average_average_back_ribs", CubeListBuilder.create().texOffs(33, 4).addBox(-4.0F, -3.4246F, -6.0F, 8.0F, 7.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0429F, -0.0754F, 0.0184F));
		...
		PartDefinition cube_r1 = back_muscular_average_average_back_top_lower_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 0).addBox(-6.08F, -6.24F, -5.52F, 7.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -2.6621F, 1.5137F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = back_muscular_average_average_back_top_upper.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 17).addBox(-4.08F, -6.24F, -6.52F, 4.0F, 9.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.1602F, 1.4702F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition stomachAnchor = back_muscular_average_average.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.5F, 7.0F));
		...
		PartDefinition playerAnchor = back_muscular_average_average.addOrReplaceChild("playerAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart back = this.back_muscular_average_average;
	...
	public Part getCubeDimensions() {
		return new Part("back_muscular_average_average", new ArrayList<>(
				Arrays.asList(
						new Block(8, 7, 12),
						new Block(7, 9, 6),
						new Block(4, 9, 7))
