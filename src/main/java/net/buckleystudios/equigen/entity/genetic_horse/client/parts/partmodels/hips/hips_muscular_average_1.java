...
public class hips_muscular_average_1 extends MultipartHipModel<GeneticHorseEntity> {
	...
	public hips_muscular_average_1(ModelPart root) {
		...
		this.backAnchor = this.hips_muscular_average_1.getChild("backAnchor");
		this.tailAnchor = this.hips_muscular_average_1.getChild("tailAnchor");
		this.backLeftLegAnchor = this.hips_muscular_average_1.getChild("backLeftLegAnchor");
		this.backRightLegAnchor = this.hips_muscular_average_1.getChild("backRightLegAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = hips_muscular_average_1_hips_top_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 69).addBox(-5.08F, -4.24F, -5.36F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -1.4516F, 2.9121F, 1.2217F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = hips_muscular_average_1_hips_top_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 81).addBox(-5.08F, -4.24F, -5.36F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -1.6226F, 2.4422F, 1.2217F, 0.0F, 0.0F));

		PartDefinition backAnchor = hips_muscular_average_1.addOrReplaceChild("backAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.325F, 0.0F));

		PartDefinition tailAnchor = hips_muscular_average_1.addOrReplaceChild("tailAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.1F, -2.15F, 3.0F));

		PartDefinition backLeftLegAnchor = hips_muscular_average_1.addOrReplaceChild("backLeftLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 3.675F, 0.5F));

		PartDefinition backRightLegAnchor = hips_muscular_average_1.addOrReplaceChild("backRightLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.5F, 3.675F, 0.5F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart hips = this.hips_muscular_average_1;
	...
	public Part getCubeDimensions() {
		return new Part("hips_muscular_average_1", new ArrayList<>(
				Arrays.asList(
						new Block(5, 7, 7),
						new Block(5, 5, 5),
						new Block(5, 7, 7),
