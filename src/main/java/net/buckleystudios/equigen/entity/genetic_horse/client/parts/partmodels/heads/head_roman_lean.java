...
public class head_roman_lean extends MultipartHeadModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head_roman_lean_jaw_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(105, 91).addBox(-2.0F, -1.5F, -2.5F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.09F)), PartPose.offsetAndRotation(0.0877F, 0.3173F, 0.2336F, 0.6545F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = head_roman_lean_jaw_branch.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(91, 101).addBox(-2.08F, -3.24F, -1.84F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6593F, -0.118F, -0.201F, 2.1817F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = head_roman_lean_nose_bridge.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(62, 101).addBox(-3.08F, -3.24F, -1.84F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(1.6569F, -0.4076F, 0.2423F, 2.9234F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = head_roman_lean_forehead.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(73, 97).addBox(-4.0524F, -4.0F, -3.0076F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1324F, -2.4201F, 0.9485F, 2.2253F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = head_roman_lean_muzzle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(110, 100).addBox(-2.4469F, -1.7862F, -3.7184F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.06F)), PartPose.offsetAndRotation(0.8204F, -0.7151F, 0.6964F, 1.0036F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = head_roman_lean_mouth.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(93, 97).addBox(-1.9832F, -0.6095F, -3.149F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.04F)), PartPose.offsetAndRotation(0.3735F, 0.0894F, 0.5176F, 1.0036F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = head_roman_lean_fringe.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(86, 130).addBox(-1.0F, -4.0F, -2.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0992F, 1.3944F, -3.0578F, -1.5615F, 0.6653F, -1.5864F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart head = this.head_roman_lean;
	...
	public Part getCubeDimensions() {
		return new Part("head_roman_lean", new ArrayList<>(
				Arrays.asList(
						new Block(4, 3, 5),
						new Block(3, 6, 3),
						new Block(3, 5, 3),
