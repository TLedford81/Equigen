...
public class back_average_long_thick extends MultipartBackModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_average_long_thick_back_ribs = back_average_long_thick.addOrReplaceChild("back_average_long_thick_back_ribs", CubeListBuilder.create().texOffs(33, 3).addBox(-3.5F, -3.9777F, -6.5F, 7.0F, 8.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0066F, -0.0223F, 0.0547F));
		...
		PartDefinition cube_r1 = back_average_long_thick_back_top_lower_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 0).addBox(-5.08F, -7.24F, -5.52F, 6.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -2.7056F, 2.0118F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = back_average_long_thick_back_top_upper.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 17).addBox(-4.08F, -7.24F, -6.52F, 4.0F, 10.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.2037F, 1.9683F, 1.6581F, 0.0F, 0.0F));

		PartDefinition chestAnchor = back_average_long_thick.addOrReplaceChild("chestAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, -6.25F));

		PartDefinition hipsAnchor = back_average_long_thick.addOrReplaceChild("hipsAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 6.5F));

		PartDefinition stomachAnchor = back_average_long_thick.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 7.45F));

		PartDefinition withersAnchor = back_average_long_thick.addOrReplaceChild("withersAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, -6.25F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart back = this.back_average_long_thick;
	...
	public Part getCubeDimensions() {
		return new Part("back_average_long_thick", new ArrayList<>(
				Arrays.asList(
						new Block(7, 8, 13),
						new Block(6, 10, 6),
						new Block(4, 10, 7))
