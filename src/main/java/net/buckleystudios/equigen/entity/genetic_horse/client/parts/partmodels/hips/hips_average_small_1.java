...
public class hips_average_small_1 extends MultipartHipModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hips_average_small_1_right_hip_glue_base_individual = hips_average_small_1_right_hip_glute_base.addOrReplaceChild("hips_average_small_1_right_hip_glue_base_individual", CubeListBuilder.create().texOffs(0, 137).addBox(-2.0F, -3.0F, -3.0F, 4.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.8883F, 0.1397F, -0.0538F));

		PartDefinition hips_average_small_1_right_hip_glue_outer = hips_average_small_1_right_hip_glute_base.addOrReplaceChild("hips_average_small_1_right_hip_glue_outer", CubeListBuilder.create().texOffs(0, 106).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.8768F, 0.113F, -0.0212F));
		...
		PartDefinition hips_average_small_1_hips_top_upper = hips_average_small_1_hips_top.addOrReplaceChild("hips_average_small_1_hips_top_upper", CubeListBuilder.create(), PartPose.offset(0.1511F, -0.1545F, 1.0025F));

		PartDefinition cube_r1 = hips_average_small_1_hips_top_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 70).addBox(-4.08F, -5.24F, -4.36F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -0.4785F, 3.7052F, 1.1781F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = hips_average_small_1_hips_top_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 81).addBox(-5.08F, -4.24F, -5.36F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -1.7433F, 2.5107F, 1.1781F, 0.0F, 0.0F));

		PartDefinition backAnchor = hips_average_small_1.addOrReplaceChild("backAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0894F, -3.0F, 0.1257F));

		PartDefinition tailAnchor = hips_average_small_1.addOrReplaceChild("tailAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0894F, -1.25F, 3.6257F));

		PartDefinition backLeftLegAnchor = hips_average_small_1.addOrReplaceChild("backLeftLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(3.3394F, 3.125F, 1.1257F));

		PartDefinition backRightLegAnchor = hips_average_small_1.addOrReplaceChild("backRightLegAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.1606F, 3.125F, 1.1257F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart hips = this.hips_average_small_1;
	...
	public Part getCubeDimensions() {
		return new Part("hips_average_small_1", new ArrayList<>(
				Arrays.asList(
						new Block(4, 6, 6),
						new Block(5, 5, 5),
						new Block(4, 6, 6),
