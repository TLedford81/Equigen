...
public class back_lean_short_thin extends MultipartBackModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_lean_short_thin_back_ribs = back_lean_short_thin.addOrReplaceChild("back_lean_short_thin_back_ribs", CubeListBuilder.create().texOffs(33, 5).addBox(-3.0F, -3.1397F, -5.5F, 6.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.0297F, 0.1397F, -0.0179F));
		...
		PartDefinition cube_r1 = back_lean_short_thin_back_top_lower_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(64, 1).addBox(-4.08F, -6.24F, -4.52F, 5.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, -2.164F, 1.5573F, 1.6581F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = back_lean_short_thin_back_top_upper.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 18).addBox(-4.08F, -6.24F, -5.52F, 4.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -2.6621F, 1.5137F, 1.6581F, 0.0F, 0.0F));

		PartDefinition chestAnchor = back_lean_short_thin.addOrReplaceChild("chestAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, -5.5F));

		PartDefinition hipsAnchor = back_lean_short_thin.addOrReplaceChild("hipsAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 5.75F));

		PartDefinition stomachAnchor = back_lean_short_thin.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 6.4F));

		PartDefinition withersAnchor = back_lean_short_thin.addOrReplaceChild("withersAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, -5.5F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart back = this.back_lean_short_thin;
	...
	public Part getCubeDimensions() {
		return new Part("back_lean_short_thin", new ArrayList<>(
				Arrays.asList(
						new Block(6, 6, 11),
						new Block(5, 9, 5),
						new Block(4, 9, 6))
