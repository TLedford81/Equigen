...
public class stomach_lean_long_low extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public stomach_lean_long_low(ModelPart root) {
		...
		this.backAnchor = this.stomach_lean_long_low.getChild("backAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = stomach_lean_long_low_stomach_front_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(60, 78).addBox(-4.0892F, -4.2676F, -5.4648F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5892F, -2.9648F, 0.7676F, 1.5708F, 0.0F, 0.0F));

		PartDefinition stomach_lean_long_low_stomach_front_lower = stomach_lean_long_low_stomach_front_upper.addOrReplaceChild("stomach_lean_long_low_stomach_front_lower", CubeListBuilder.create(), PartPose.offset(0.0026F, -0.5018F, -0.9428F));

		PartDefinition cube_r2 = stomach_lean_long_low_stomach_front_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(84, 78).addBox(-4.08F, -5.24F, -5.52F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.02F, 1.74F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = stomach_lean_long_low_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(40, 101).addBox(-5.0984F, -6.2952F, -5.4096F, 5.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5984F, -3.4091F, -0.3014F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_lean_long_low_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(42, 84).addBox(-4.08F, -6.24F, -5.52F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.5082F, -0.3749F, 1.7453F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart stomach = this.stomach_lean_long_low;

		registerAnchorPath("backAnchor", root, stomach, this.backAnchor);
	}
	@Override
	public Part getCubeDimensions() {
		return new Part("stomach_lean_long_low", new ArrayList<>(
				Arrays.asList(
						new Block(5, 7, 5),
						new Block(4, 7, 5),
						new Block(5, 13, 4),
