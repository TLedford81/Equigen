package net.buckleystudios.equigen.entity.genetic_horse.client.parts.partmodels.hooves;// Made with Blockbench 4.12.2
...
import net.buckleystudios.equigen.entity.genetic_horse.client.parts.multipart.MultipartHoofModel;
...
public class hoof_large extends MultipartHoofModel<GeneticHorseEntity> {
    ...
    public static LayerDefinition createBodyLayer(GeneticValues.LEG leg) {
        ...
        PartDefinition hoof_large_individual = hoof_large.addOrReplaceChild("hoof_large_individual", CubeListBuilder.create().texOffs(uvXOffset, uvYOffset).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.0335F, 0.0F));
    ...
    protected void defineAnchorPaths() {
        ...
        ModelPart hoof = this.hoof_large;

        registerAnchorPath("bottomLegAnchor", root, hoof, this.bottomLegAnchor);

    }

    @Override
    public Part getCubeDimensions() {
        return new Part("hoof_large", new ArrayList<>(
                List.of(
                        new Block(2, 2, 3))
        ));
    }
