...
public class tail_thin_long extends MultipartTailModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = tail_thin_long_tail_connector_rotator.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(31, 98).addBox(-0.5531F, 0.0071F, -0.555F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5363F, -1.8771F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = tail_thin_long_tail_top_individual.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(26, 123).addBox(-1.0F, -1.0785F, 0.1082F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4469F, -0.2682F, -0.2682F, -1.3963F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = tail_thin_long_tail_middle_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(66, 63).addBox(-1.0F, -0.9635F, -0.1495F, 3.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6257F, -0.0179F, 0.6257F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = tail_thin_long_tail_bottom.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(87, 60).addBox(-1.0F, -0.8391F, -0.9493F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2682F, 0.5363F, 0.0894F, -1.5708F, 0.0F, 0.0F));
	...
	public Part getCubeDimensions() {
		return new Part("tail_thin_long", new ArrayList<>(
				Arrays.asList(
						new Block(1, 1, 3),
						new Block(2, 2, 4),
						new Block(3, 3, 10),
