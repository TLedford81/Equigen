...
public class stomach_lean_long_high extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = stomach_lean_long_high_stomach_front_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(566, 350).addBox(-4.0892F, -2.2676F, -5.4648F, 5.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5892F, -3.4648F, -3.7324F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = stomach_lean_long_high_stomach_front_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(584, 350).addBox(-4.08F, -3.24F, -5.52F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.52F, -2.76F, 1.5708F, 0.0F, 0.0F));
