...
public class GH_WalkAnimation extends GH_Animations {
    public static AnimationDefinition animate(String part, int legID) {
        ...
        return ModAnimationDefinition.Builder.withLength(3.0F).looping().setPart(part, legID)
                ...
                .addAnimation("top_front_legs", LegID_FrontLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("knee", LegID_FrontLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("bottom_legs", LegID_FrontLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("top_front_legs", LegID_FrontRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("knee", LegID_FrontRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("bottom_legs", LegID_FrontRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("tail", "_tail_top", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("top_back_legs", LegID_BackLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("knee", LegID_BackLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("bottom_legs", LegID_BackLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("hoof", LegID_BackLeft, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("top_back_legs", LegID_BackRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("knee", LegID_BackRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("bottom_legs", LegID_BackRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("hoof", LegID_BackRight, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(-16.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.25F, KeyframeAnimations.degreeVec(5.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
