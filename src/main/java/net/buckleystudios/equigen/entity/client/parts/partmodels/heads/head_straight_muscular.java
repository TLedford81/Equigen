...
//
//
//public class head_straight_muscular<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "head_straight_muscular"), "main");
//	private final ModelPart head_straight_muscular;
//	private final ModelPart head_straight_muscular_jaw;
//	private final ModelPart head_jaw_individual;
//	private final ModelPart head_jaw_branch;
//	private final ModelPart head_straight_muscular_nose_bridge;
//	private final ModelPart head_straight_muscular_forehead;
//	private final ModelPart head_straight_muscular_fringe;
//	private final ModelPart head_straight_muscular_muzzle;
//	private final ModelPart head_straight_muscular_muzzle_individual;
//	private final ModelPart head_straight_muscular_mouth;
//
//	public head_straight_muscular(ModelPart root) {
//		this.head_straight_muscular = root.getChild("head_straight_muscular");
//		this.head_straight_muscular_jaw = this.head_straight_muscular.getChild("head_straight_muscular_jaw");
//		this.head_jaw_individual = this.head_straight_muscular_jaw.getChild("head_jaw_individual");
//		this.head_jaw_branch = this.head_straight_muscular_jaw.getChild("head_jaw_branch");
//		this.head_straight_muscular_nose_bridge = this.head_straight_muscular.getChild("head_straight_muscular_nose_bridge");
//		this.head_straight_muscular_forehead = this.head_straight_muscular.getChild("head_straight_muscular_forehead");
//		this.head_straight_muscular_fringe = this.head_straight_muscular.getChild("head_straight_muscular_fringe");
//		this.head_straight_muscular_muzzle = this.head_straight_muscular.getChild("head_straight_muscular_muzzle");
//		this.head_straight_muscular_muzzle_individual = this.head_straight_muscular_muzzle.getChild("head_straight_muscular_muzzle_individual");
//		this.head_straight_muscular_mouth = this.head_straight_muscular_muzzle.getChild("head_straight_muscular_mouth");
//	}
//
...
//		head_straight_muscular.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}