...
public class neck_muscular_ewed_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_ewed_average_2(ModelPart root) {
		...
		this.withersAnchor = this.neck_muscular_ewed_average_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition withersAnchor = neck_muscular_ewed_average_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.2F, -1.5346F, 1.9529F));
