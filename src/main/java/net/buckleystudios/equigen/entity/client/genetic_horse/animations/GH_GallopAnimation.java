...
public class GH_GallopAnimation extends GH_Animation {

    //TODO: Translate this and fix any continuity errors

    public static AnimationDefinition animate(String part, int legID) {
        if (!isValidLegID(legID)) return inanimate();

        return ModAnimationDefinition.Builder.withLength(1.0F).looping().setPart(part, legID)
