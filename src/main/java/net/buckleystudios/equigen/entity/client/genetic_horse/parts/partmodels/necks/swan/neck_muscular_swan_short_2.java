...
public class neck_muscular_swan_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_swan_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_swan_short_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_muscular_swan_short_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.1495F, -3.4876F, -3.5247F));
		...
		PartDefinition cube_r3 = neck_muscular_swan_short_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(425, 1006).addBox(-5.08F, -12.0F, -0.92F, 5.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 7.0087F, 4.8099F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_muscular_swan_short_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(406, 993).addBox(-5.0F, -10.0F, -2.0F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0139F, 4.4419F, 3.2252F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_muscular_swan_short_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(405, 1006).addBox(-7.08F, -9.0F, -0.92F, 6.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0661F, 6.4792F, -0.0428F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_muscular_swan_short_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(428, 994).addBox(-5.0784F, -9.0F, -0.9017F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 5.1192F, 0.0099F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_muscular_swan_short_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(771, 997).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.9663F, 1.0647F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_muscular_swan_short_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(771, 1005).addBox(-2.0F, -2.0F, -5.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 2.3759F, 0.7779F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_muscular_swan_short_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(755, 999).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_muscular_swan_short_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(783, 1001).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.7634F, -2.6136F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_muscular_swan_short_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(781, 1011).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -1.4669F, -3.0163F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_muscular_swan_short_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(761, 1004).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2681F, 0.1788F, 0.4469F, -0.8937F, -0.1201F, -0.1036F));
