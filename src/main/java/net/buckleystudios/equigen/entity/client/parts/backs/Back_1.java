package net.buckleystudios.equigen.entity.client.parts.backs;
...
public class Back_1 extends HierarchicalModel<GeneticHorseEntity> {
    private final ModelPart body;
//    private final ModelPart head;

    public Back_1(ModelPart root) {
