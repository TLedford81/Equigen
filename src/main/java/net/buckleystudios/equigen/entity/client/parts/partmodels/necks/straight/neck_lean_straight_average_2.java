...
public class neck_lean_straight_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_straight_average_2(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_straight_average_2.getChild("headAnchor");
		this.chestAnchor = this.neck_lean_straight_average_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_lean_straight_average_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = neck_lean_straight_average_2_crest_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(555, 829).addBox(-3.08F, -5.0F, -0.92F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 0.7064F, 1.3256F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition headAnchor = neck_lean_straight_average_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.1F, -9.25F, -4.366F));
		...
		PartDefinition withersAnchor = neck_lean_straight_average_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.1F, -0.5346F, 3.4529F));
