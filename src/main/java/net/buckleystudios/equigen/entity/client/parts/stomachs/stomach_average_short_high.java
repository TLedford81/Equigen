...
//
//
//public class stomach_average_short_high<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "stomach_average_short_high"), "main");
//	private final ModelPart stomach_average_short_high;
//	private final ModelPart stomach_average_short_high_stomach_front_upper;
//	private final ModelPart stomach_average_short_high_stomach_front_upper_individual;
//	private final ModelPart stomach_average_short_high_stomach_front_lower;
//	private final ModelPart stomach_average_short_high_stomach_back_upper;
//	private final ModelPart stomach_average_short_high_stomach_back_upper_individual;
//	private final ModelPart stomach_average_short_high_stomach_back_lower;
//
//	public stomach_average_short_high(ModelPart root) {
//		this.stomach_average_short_high = root.getChild("stomach_average_short_high");
//		this.stomach_average_short_high_stomach_front_upper = this.stomach_average_short_high.getChild("stomach_average_short_high_stomach_front_upper");
//		this.stomach_average_short_high_stomach_front_upper_individual = this.stomach_average_short_high_stomach_front_upper.getChild("stomach_average_short_high_stomach_front_upper_individual");
//		this.stomach_average_short_high_stomach_front_lower = this.stomach_average_short_high_stomach_front_upper.getChild("stomach_average_short_high_stomach_front_lower");
//		this.stomach_average_short_high_stomach_back_upper = this.stomach_average_short_high.getChild("stomach_average_short_high_stomach_back_upper");
//		this.stomach_average_short_high_stomach_back_upper_individual = this.stomach_average_short_high_stomach_back_upper.getChild("stomach_average_short_high_stomach_back_upper_individual");
//		this.stomach_average_short_high_stomach_back_lower = this.stomach_average_short_high_stomach_back_upper.getChild("stomach_average_short_high_stomach_back_lower");
//	}
//
...
//		stomach_average_short_high.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}