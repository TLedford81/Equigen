...
public class neck_lean_straight_long_1 extends HierarchicalModel<GeneticHorseEntity> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_lean_straight_long_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
