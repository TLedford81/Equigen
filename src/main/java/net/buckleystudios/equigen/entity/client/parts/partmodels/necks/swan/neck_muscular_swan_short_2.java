...
public class neck_muscular_swan_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_swan_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_swan_short_2.getChild("headAnchor");
		this.chestAnchor = this.neck_muscular_swan_short_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_muscular_swan_short_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r8 = neck_muscular_swan_short_2_top_mane_flow.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(755, 999).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_muscular_swan_short_2_bottom_mane_flow.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(761, 1004).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2681F, 0.1788F, 0.4469F, -0.8937F, -0.1201F, -0.1036F));

		PartDefinition headAnchor = neck_muscular_swan_short_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.1F, -8.8827F, -6.1739F));
		...
		PartDefinition withersAnchor = neck_muscular_swan_short_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.2F, -1.8346F, 3.3529F, 0.0436F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_muscular_swan_short_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
