...
public class neck_average_swan_short_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition withersAnchor = neck_average_swan_short_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1F, -2.1346F, 3.3529F, 0.0436F, 0.0F, 0.0F));
