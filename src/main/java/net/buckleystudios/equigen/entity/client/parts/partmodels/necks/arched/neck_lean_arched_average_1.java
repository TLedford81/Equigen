...
public class neck_lean_arched_average_1 extends HierarchicalModel<GeneticHorseEntity> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_lean_arched_average_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
