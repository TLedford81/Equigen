...
//
//
//public class chest_average_average_2<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "chest_average_average_2"), "main");
//	private final ModelPart chest_average_average_2;
//	private final ModelPart chest_average_average_2_chest_front;
//	private final ModelPart chest_average_average_2_chest_front_upper;
//	private final ModelPart chest_average_average_2_chest_front_lower;
//	private final ModelPart chest_average_average_2_chest_left;
//	private final ModelPart chest_average_average_2_chest_left_pectoral;
//	private final ModelPart chest_average_average_2_chest_left_pectoral_top;
//	private final ModelPart chest_average_average_2_chest_left_pectoral_middle;
//	private final ModelPart chest_average_average_2_chest_left_pectoral_bottom;
//	private final ModelPart chest_average_average_2_chest_left_deltoid;
//	private final ModelPart chest_average_average_2_chest_left_deltoid_outer;
//	private final ModelPart chest_average_average_2_chest_left_deltoid_base;
//	private final ModelPart chest_average_average_2_chest_right;
//	private final ModelPart chest_average_average_2_chest_right_pectoral;
//	private final ModelPart chest_average_average_2_chest_right_pectoral_top;
//	private final ModelPart chest_average_average_2_chest_right_pectoral_middle;
//	private final ModelPart chest_average_average_2_chest_right_pectoral_bottom;
//	private final ModelPart chest_average_average_2_chest_right_deltoid;
//	private final ModelPart chest_average_average_2_chest_right_deltoid_outer;
//	private final ModelPart chest_average_average_2_chest_right_deltoid_base;
//
//	public chest_average_average_2(ModelPart root) {
//		this.chest_average_average_2 = root.getChild("chest_average_average_2");
//		this.chest_average_average_2_chest_front = this.chest_average_average_2.getChild("chest_average_average_2_chest_front");
//		this.chest_average_average_2_chest_front_upper = this.chest_average_average_2_chest_front.getChild("chest_average_average_2_chest_front_upper");
//		this.chest_average_average_2_chest_front_lower = this.chest_average_average_2_chest_front.getChild("chest_average_average_2_chest_front_lower");
//		this.chest_average_average_2_chest_left = this.chest_average_average_2.getChild("chest_average_average_2_chest_left");
//		this.chest_average_average_2_chest_left_pectoral = this.chest_average_average_2_chest_left.getChild("chest_average_average_2_chest_left_pectoral");
//		this.chest_average_average_2_chest_left_pectoral_top = this.chest_average_average_2_chest_left_pectoral.getChild("chest_average_average_2_chest_left_pectoral_top");
//		this.chest_average_average_2_chest_left_pectoral_middle = this.chest_average_average_2_chest_left_pectoral.getChild("chest_average_average_2_chest_left_pectoral_middle");
//		this.chest_average_average_2_chest_left_pectoral_bottom = this.chest_average_average_2_chest_left_pectoral.getChild("chest_average_average_2_chest_left_pectoral_bottom");
//		this.chest_average_average_2_chest_left_deltoid = this.chest_average_average_2_chest_left.getChild("chest_average_average_2_chest_left_deltoid");
//		this.chest_average_average_2_chest_left_deltoid_outer = this.chest_average_average_2_chest_left_deltoid.getChild("chest_average_average_2_chest_left_deltoid_outer");
//		this.chest_average_average_2_chest_left_deltoid_base = this.chest_average_average_2_chest_left_deltoid.getChild("chest_average_average_2_chest_left_deltoid_base");
//		this.chest_average_average_2_chest_right = this.chest_average_average_2.getChild("chest_average_average_2_chest_right");
//		this.chest_average_average_2_chest_right_pectoral = this.chest_average_average_2_chest_right.getChild("chest_average_average_2_chest_right_pectoral");
//		this.chest_average_average_2_chest_right_pectoral_top = this.chest_average_average_2_chest_right_pectoral.getChild("chest_average_average_2_chest_right_pectoral_top");
//		this.chest_average_average_2_chest_right_pectoral_middle = this.chest_average_average_2_chest_right_pectoral.getChild("chest_average_average_2_chest_right_pectoral_middle");
//		this.chest_average_average_2_chest_right_pectoral_bottom = this.chest_average_average_2_chest_right_pectoral.getChild("chest_average_average_2_chest_right_pectoral_bottom");
//		this.chest_average_average_2_chest_right_deltoid = this.chest_average_average_2_chest_right.getChild("chest_average_average_2_chest_right_deltoid");
//		this.chest_average_average_2_chest_right_deltoid_outer = this.chest_average_average_2_chest_right_deltoid.getChild("chest_average_average_2_chest_right_deltoid_outer");
//		this.chest_average_average_2_chest_right_deltoid_base = this.chest_average_average_2_chest_right_deltoid.getChild("chest_average_average_2_chest_right_deltoid_base");
//	}
//
...
//		chest_average_average_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}