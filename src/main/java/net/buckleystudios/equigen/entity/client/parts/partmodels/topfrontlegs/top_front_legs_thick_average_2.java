...
public class top_front_legs_thick_average_2 extends MultipartFrontTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = top_front_legs_thick_average_2_top_front_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(316, 204).mirror().addBox(-1.1889F, -2.0F, -2.02F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1889F, 1.7166F, 1.4048F, 1.789F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = top_front_legs_thick_average_2_top_front_back.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(317, 214).mirror().addBox(-0.7685F, -3.0F, -1.84F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.2315F, 1.7238F, 1.4262F, 1.5272F, 0.0F, 0.0F));

		PartDefinition chestAnchor = top_front_legs_thick_average_2.addOrReplaceChild("chestAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.35F, -0.15F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		top_front_legs_thick_average_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
