...
public class neck_lean_straight_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_straight_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_straight_short_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_straight_short_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0548F, 0.5415F, -3.5985F));
		...
		PartDefinition cube_r3 = neck_lean_straight_short_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(442, 832).addBox(-3.08F, -5.0F, -0.92F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 1.129F, 2.232F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_straight_short_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(415, 820).addBox(-4.0708F, -11.03F, -0.9292F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0811F, 6.614F, 3.9008F, 0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_lean_straight_short_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(431, 821).addBox(-3.0F, -7.0F, -1.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9897F, 1.1105F, 3.5457F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_straight_short_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(428, 832).addBox(-4.0784F, -5.0F, -0.9017F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 2.3336F, 1.4179F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_straight_short_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(776, 911).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_straight_short_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(776, 918).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_straight_short_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(762, 912).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r11 = neck_lean_straight_short_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(785, 914).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -3.1044F, -3.3945F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_straight_short_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(783, 923).addBox(-2.0F, -2.0F, 1.0F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.8258F, -3.8098F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_lean_straight_short_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(767, 917).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.2682F, 0.0F, -0.9774F, -0.0927F, -0.1377F));
