...
public class neck_muscular_ewed_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_ewed_long_1(ModelPart root) {
		...
		this.withersAnchor = this.neck_muscular_ewed_long_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition withersAnchor = neck_muscular_ewed_long_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.2F, -1.8346F, 2.6529F));
