...
//
//
//public class stomach_lean_average_medium<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "stomach_lean_average_medium"), "main");
//	private final ModelPart stomach_lean_average_medium;
//	private final ModelPart stomach_lean_average_medium_stomach_front_upper;
//	private final ModelPart stomach_lean_average_medium_stomach_front_upper_individual;
//	private final ModelPart stomach_lean_average_medium_stomach_front_lower;
//	private final ModelPart stomach_lean_average_medium_stomach_back_upper;
//	private final ModelPart stomach_lean_average_medium_stomach_back_upper_individual;
//	private final ModelPart stomach_lean_average_medium_stomach_back_lower;
//
...
//		this.stomach_lean_average_medium_stomach_front_upper = this.stomach_lean_average_medium.getChild("stomach_lean_average_medium_stomach_front_upper");
//		this.stomach_lean_average_medium_stomach_front_upper_individual = this.stomach_lean_average_medium_stomach_front_upper.getChild("stomach_lean_average_medium_stomach_front_upper_individual");
//		this.stomach_lean_average_medium_stomach_front_lower = this.stomach_lean_average_medium_stomach_front_upper.getChild("stomach_lean_average_medium_stomach_front_lower");
//		this.stomach_lean_average_medium_stomach_back_upper = this.stomach_lean_average_medium.getChild("stomach_lean_average_medium_stomach_back_upper");
//		this.stomach_lean_average_medium_stomach_back_upper_individual = this.stomach_lean_average_medium_stomach_back_upper.getChild("stomach_lean_average_medium_stomach_back_upper_individual");
//		this.stomach_lean_average_medium_stomach_back_lower = this.stomach_lean_average_medium_stomach_back_upper.getChild("stomach_lean_average_medium_stomach_back_lower");
//	}
//
...
//		stomach_lean_average_medium.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}