...
public class stomach_lean_long_low<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "stomach_lean_long_low"), "main");
	private final ModelPart stomach_lean_long_low;
	private final ModelPart stomach_lean_long_low_stomach_front_upper;
	private final ModelPart stomach_lean_long_low_stomach_front_upper_individual;
	private final ModelPart stomach_lean_long_low_stomach_front_lower;
	private final ModelPart stomach_lean_long_low_stomach_back_upper;
	private final ModelPart stomach_lean_long_low_stomach_back_upper_individual;
	private final ModelPart stomach_lean_long_low_stomach_back_lower;

	public stomach_lean_long_low(ModelPart root) {
		this.stomach_lean_long_low = root.getChild("stomach_lean_long_low");
		this.stomach_lean_long_low_stomach_front_upper = this.stomach_lean_long_low.getChild("stomach_lean_long_low_stomach_front_upper");
		this.stomach_lean_long_low_stomach_front_upper_individual = this.stomach_lean_long_low_stomach_front_upper.getChild("stomach_lean_long_low_stomach_front_upper_individual");
		this.stomach_lean_long_low_stomach_front_lower = this.stomach_lean_long_low_stomach_front_upper.getChild("stomach_lean_long_low_stomach_front_lower");
		this.stomach_lean_long_low_stomach_back_upper = this.stomach_lean_long_low.getChild("stomach_lean_long_low_stomach_back_upper");
		this.stomach_lean_long_low_stomach_back_upper_individual = this.stomach_lean_long_low_stomach_back_upper.getChild("stomach_lean_long_low_stomach_back_upper_individual");
		this.stomach_lean_long_low_stomach_back_lower = this.stomach_lean_long_low_stomach_back_upper.getChild("stomach_lean_long_low_stomach_back_lower");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		stomach_lean_long_low.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}