...
public class chest_muscular_large_1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "chest_muscular_large_1"), "main");
	private final ModelPart chest_muscular_large_1;
	private final ModelPart chest_muscular_large_1_chest_front;
	private final ModelPart chest_muscular_large_1_chest_front_upper;
	private final ModelPart chest_muscular_large_1_chest_front_lower;
	private final ModelPart chest_muscular_large_1_chest_left;
	private final ModelPart chest_muscular_large_1_chest_left_pectoral;
	private final ModelPart chest_muscular_large_1_chest_left_pectoral_top;
	private final ModelPart chest_muscular_large_1_chest_left_pectoral_middle;
	private final ModelPart chest_muscular_large_1_chest_left_pectoral_bottom;
	private final ModelPart chest_muscular_large_1_chest_left_deltoid;
	private final ModelPart chest_muscular_large_1_chest_left_deltoid_outer;
	private final ModelPart chest_muscular_large_1_chest_left_deltoid_base;
	private final ModelPart chest_muscular_large_1_chest_right;
	private final ModelPart chest_muscular_large_1_chest_right_pectoral;
	private final ModelPart chest_muscular_large_1_chest_right_pectoral_top;
	private final ModelPart chest_muscular_large_1_chest_right_pectoral_middle;
	private final ModelPart chest_muscular_large_1_chest_right_pectoral_bottom;
	private final ModelPart chest_muscular_large_1_chest_right_deltoid;
	private final ModelPart chest_muscular_large_1_chest_right_deltoid_outer;
	private final ModelPart chest_muscular_large_1_chest_right_deltoid_base;

	public chest_muscular_large_1(ModelPart root) {
		this.chest_muscular_large_1 = root.getChild("chest_muscular_large_1");
		this.chest_muscular_large_1_chest_front = this.chest_muscular_large_1.getChild("chest_muscular_large_1_chest_front");
		this.chest_muscular_large_1_chest_front_upper = this.chest_muscular_large_1_chest_front.getChild("chest_muscular_large_1_chest_front_upper");
		this.chest_muscular_large_1_chest_front_lower = this.chest_muscular_large_1_chest_front.getChild("chest_muscular_large_1_chest_front_lower");
		this.chest_muscular_large_1_chest_left = this.chest_muscular_large_1.getChild("chest_muscular_large_1_chest_left");
		this.chest_muscular_large_1_chest_left_pectoral = this.chest_muscular_large_1_chest_left.getChild("chest_muscular_large_1_chest_left_pectoral");
		this.chest_muscular_large_1_chest_left_pectoral_top = this.chest_muscular_large_1_chest_left_pectoral.getChild("chest_muscular_large_1_chest_left_pectoral_top");
		this.chest_muscular_large_1_chest_left_pectoral_middle = this.chest_muscular_large_1_chest_left_pectoral.getChild("chest_muscular_large_1_chest_left_pectoral_middle");
		this.chest_muscular_large_1_chest_left_pectoral_bottom = this.chest_muscular_large_1_chest_left_pectoral.getChild("chest_muscular_large_1_chest_left_pectoral_bottom");
		this.chest_muscular_large_1_chest_left_deltoid = this.chest_muscular_large_1_chest_left.getChild("chest_muscular_large_1_chest_left_deltoid");
		this.chest_muscular_large_1_chest_left_deltoid_outer = this.chest_muscular_large_1_chest_left_deltoid.getChild("chest_muscular_large_1_chest_left_deltoid_outer");
		this.chest_muscular_large_1_chest_left_deltoid_base = this.chest_muscular_large_1_chest_left_deltoid.getChild("chest_muscular_large_1_chest_left_deltoid_base");
		this.chest_muscular_large_1_chest_right = this.chest_muscular_large_1.getChild("chest_muscular_large_1_chest_right");
		this.chest_muscular_large_1_chest_right_pectoral = this.chest_muscular_large_1_chest_right.getChild("chest_muscular_large_1_chest_right_pectoral");
		this.chest_muscular_large_1_chest_right_pectoral_top = this.chest_muscular_large_1_chest_right_pectoral.getChild("chest_muscular_large_1_chest_right_pectoral_top");
		this.chest_muscular_large_1_chest_right_pectoral_middle = this.chest_muscular_large_1_chest_right_pectoral.getChild("chest_muscular_large_1_chest_right_pectoral_middle");
		this.chest_muscular_large_1_chest_right_pectoral_bottom = this.chest_muscular_large_1_chest_right_pectoral.getChild("chest_muscular_large_1_chest_right_pectoral_bottom");
		this.chest_muscular_large_1_chest_right_deltoid = this.chest_muscular_large_1_chest_right.getChild("chest_muscular_large_1_chest_right_deltoid");
		this.chest_muscular_large_1_chest_right_deltoid_outer = this.chest_muscular_large_1_chest_right_deltoid.getChild("chest_muscular_large_1_chest_right_deltoid_outer");
		this.chest_muscular_large_1_chest_right_deltoid_base = this.chest_muscular_large_1_chest_right_deltoid.getChild("chest_muscular_large_1_chest_right_deltoid_base");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		chest_muscular_large_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}