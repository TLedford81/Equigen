...
//
//
//public class tail_thin_short<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "tail_thin_short"), "main");
//	private final ModelPart tail_thin_short;
//	private final ModelPart tail_thin_short_tail_connector;
//	private final ModelPart tail_thin_short_tail_connector_rotator;
//	private final ModelPart tail_thin_short_tail_top;
//	private final ModelPart tail_thin_short_tail_top_individual;
//	private final ModelPart tail_thin_short_tail_middle;
//	private final ModelPart tail_thin_short_tail_middle_individual;
//	private final ModelPart tail_thin_short_tail_bottom;
//
//	public tail_thin_short(ModelPart root) {
//		this.tail_thin_short = root.getChild("tail_thin_short");
//		this.tail_thin_short_tail_connector = this.tail_thin_short.getChild("tail_thin_short_tail_connector");
//		this.tail_thin_short_tail_connector_rotator = this.tail_thin_short_tail_connector.getChild("tail_thin_short_tail_connector_rotator");
//		this.tail_thin_short_tail_top = this.tail_thin_short_tail_connector.getChild("tail_thin_short_tail_top");
//		this.tail_thin_short_tail_top_individual = this.tail_thin_short_tail_top.getChild("tail_thin_short_tail_top_individual");
//		this.tail_thin_short_tail_middle = this.tail_thin_short_tail_top.getChild("tail_thin_short_tail_middle");
//		this.tail_thin_short_tail_middle_individual = this.tail_thin_short_tail_middle.getChild("tail_thin_short_tail_middle_individual");
//		this.tail_thin_short_tail_bottom = this.tail_thin_short_tail_middle.getChild("tail_thin_short_tail_bottom");
//	}
//
...
//		tail_thin_short.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}