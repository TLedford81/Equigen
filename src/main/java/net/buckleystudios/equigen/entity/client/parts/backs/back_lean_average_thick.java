...
public class back_lean_average_thick<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "back_lean_average_thick"), "main");
	private final ModelPart back_lean_average_thick;
	private final ModelPart back_lean_average_thick_back_ribs;
	private final ModelPart back_lean_average_thick_back_top_lower;
	private final ModelPart back_lean_average_thick_back_top_lower_individual;
	private final ModelPart back_lean_average_thick_back_top_upper;

	public back_lean_average_thick(ModelPart root) {
		this.back_lean_average_thick = root.getChild("back_lean_average_thick");
		this.back_lean_average_thick_back_ribs = this.back_lean_average_thick.getChild("back_lean_average_thick_back_ribs");
		this.back_lean_average_thick_back_top_lower = this.back_lean_average_thick.getChild("back_lean_average_thick_back_top_lower");
		this.back_lean_average_thick_back_top_lower_individual = this.back_lean_average_thick_back_top_lower.getChild("back_lean_average_thick_back_top_lower_individual");
		this.back_lean_average_thick_back_top_upper = this.back_lean_average_thick_back_top_lower.getChild("back_lean_average_thick_back_top_upper");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		back_lean_average_thick.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}