...
public class GeneticHorseAnimations {
        public static AnimationDefinition gallop(String part) {
            if (part.startsWith("chest")){
                ...
                return AnimationDefinition.Builder.withLength(1.0F).addAnimation(part, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                return AnimationDefinition.Builder.withLength(1.25F).looping()
                        .addAnimation(part, new AnimationChannel(AnimationChannel.Targets.ROTATION,
               ...
               //There is no hips animation in this file so I just copy pasted the chest.
            ...
            else if(part.startsWith("stomach")){
                //There is no stomach animation so I copied the chest animation.
                return AnimationDefinition.Builder.withLength(1.0F)
                        .addAnimation(part, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                                new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                                new Keyframe(0.1667F, KeyframeAnimations.degreeVec(6.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                return AnimationDefinition.Builder.withLength(1.0F)
                        .addAnimation(part + "_tail_top", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            else return AnimationDefinition.Builder.withLength(1.0F).build();
        }
}
/*
