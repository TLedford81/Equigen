...
public class neck_lean_ewed_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_ewed_long_1_crest_upper_individual.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.009F, -1.604F, -3.1891F));
		...
		PartDefinition cube_r6 = neck_lean_ewed_long_1_crest_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(610, 710).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 1.6842F, 1.0816F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_lean_ewed_long_1_middle_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(595, 695).addBox(-3.0F, -8.0F, -1.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.6215F, 0.6148F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_ewed_long_1_lower_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(611, 695).addBox(-4.0784F, -8.0F, -0.9017F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 2.6991F, -0.4138F, 0.2618F, 0.0F, 0.0F));
