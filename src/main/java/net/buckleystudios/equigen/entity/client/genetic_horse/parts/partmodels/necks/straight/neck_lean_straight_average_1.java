...
public class neck_lean_straight_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_straight_average_1(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_straight_average_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_straight_average_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0048F, 0.5792F, -3.3122F));
		...
		PartDefinition cube_r3 = neck_lean_straight_average_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(499, 830).addBox(-3.08F, -5.0F, -0.92F, 3.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 0.9177F, 1.7788F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_straight_average_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(489, 818).addBox(-3.0F, -7.0F, -1.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9897F, 1.0357F, 2.9669F, 1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_lean_straight_average_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(471, 816).addBox(-4.0708F, -11.03F, -0.9292F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0811F, 6.5392F, 3.322F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_straight_average_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(485, 830).addBox(-4.0784F, -5.0F, -0.9017F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 2.0468F, 1.0083F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_straight_average_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(823, 910).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_straight_average_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(823, 917).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_straight_average_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(809, 911).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r11 = neck_lean_straight_average_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(832, 911).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -3.514F, -3.6813F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_straight_average_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(831, 921).addBox(-2.0F, -2.0F, 1.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -3.2354F, -4.0966F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_lean_straight_average_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(813, 915).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -1.5196F, -0.8045F, -0.9774F, -0.0927F, -0.1377F));
