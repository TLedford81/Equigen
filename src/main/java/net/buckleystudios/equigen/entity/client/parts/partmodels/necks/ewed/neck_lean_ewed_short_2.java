...
public class neck_lean_ewed_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_ewed_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_ewed_short_2.getChild("headAnchor");
		this.chestAnchor = this.neck_lean_ewed_short_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_lean_ewed_short_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_ewed_short_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.15F, -9.3827F, -5.6739F));
		...
		PartDefinition withersAnchor = neck_lean_ewed_short_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.2F, -2.1346F, 1.2529F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_lean_ewed_short_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
