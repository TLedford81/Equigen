...
public class neck_lean_swan_short_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_swan_short_1(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_swan_short_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_swan_short_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0769F, -2.5117F, -4.2924F));
		...
		PartDefinition cube_r3 = neck_lean_swan_short_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(365, 960).addBox(-3.08F, -12.0F, -0.92F, 3.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 7.4183F, 5.0967F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_swan_short_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(349, 946).addBox(-4.0F, -10.0F, -2.0F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0055F, 4.8942F, 3.4242F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_lean_swan_short_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(349, 958).addBox(-5.08F, -9.0F, -0.92F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0745F, 6.9315F, 0.1563F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_swan_short_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(367, 947).addBox(-5.0784F, -9.0F, -0.9017F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5784F, 5.6074F, 0.1181F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_swan_short_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(723, 972).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.9663F, 1.0647F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_swan_short_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(724, 980).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.3759F, 0.7779F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_swan_short_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(709, 974).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_lean_swan_short_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(734, 977).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.3667F, -2.3092F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_swan_short_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(724, 987).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.0702F, -2.7119F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_lean_swan_short_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(715, 980).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5363F, 0.7151F, 0.8045F, -0.8937F, -0.1201F, -0.1036F));
