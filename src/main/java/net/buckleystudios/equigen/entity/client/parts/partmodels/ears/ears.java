package net.buckleystudios.equigen.entity.client.parts.partmodels.ears;// Made with Blockbench 4.12.2
...
import net.buckleystudios.equigen.entity.client.parts.MultipartEarModel;
