package net.buckleystudios.equigen.entity.client.genetic_horse.parts.partmodels;
...
public class PartModelCache {
    private static final Map<String, EntityModel<GeneticHorseEntity>> partCache = new HashMap<>();
    ...
    private static MultipartModel<GeneticHorseEntity> asMultipartModel(String id, EntityModelSet modelSet) {
        if (id == null) return null;
        EntityModel<GeneticHorseEntity> base = getPartModel(id, modelSet);
    ...
    public static MultipartModel<GeneticHorseEntity> getMultipartModel(EntityModelSet modelSet, List<String> partsToRender, String prefix) {
        return asMultipartModel(getPartFromPrefix(partsToRender, prefix), modelSet);
    }

    public static EntityModel<GeneticHorseEntity> getPartModel(String partId, EntityModelSet modelSet) {
