...
public class neck_lean_straight_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = neck_lean_straight_average_2_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(875, 908).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_lean_straight_average_2_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(875, 915).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_straight_average_2_top_mane_flow.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(861, 909).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r6 = neck_lean_straight_average_2_crest_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(555, 829).addBox(-3.08F, -5.0F, -0.92F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 0.7064F, 1.3256F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_straight_average_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(884, 907).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -3.9236F, -3.9681F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_straight_average_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(884, 918).addBox(-2.0F, -2.0F, 1.0F, 2.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -3.645F, -4.3834F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_straight_average_2_bottom_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(864, 912).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -1.5196F, -0.8045F, -0.9753F, -0.1144F, -0.1002F));
		...
		PartDefinition cube_r11 = neck_lean_straight_average_2_middle_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(545, 816).addBox(-3.0F, -7.0F, -1.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9897F, 0.9481F, 2.4594F, 1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r12 = neck_lean_straight_average_2_middle_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(527, 814).addBox(-4.0708F, -11.03F, -0.9292F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0811F, 6.094F, 2.9933F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_lean_straight_average_2_lower_individual.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(541, 829).addBox(-4.0784F, -5.0F, -0.9017F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 1.76F, 0.5988F, 0.9599F, 0.0F, 0.0F));
