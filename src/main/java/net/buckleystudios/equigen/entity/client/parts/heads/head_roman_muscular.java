...
public class head_roman_muscular<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "head_roman_muscular"), "main");
	private final ModelPart head_roman_muscular;
	private final ModelPart head_roman_muscular_jaw;
	private final ModelPart head_jaw_individual;
	private final ModelPart head_jaw_branch;
	private final ModelPart head_roman_muscular_nose_bridge;
	private final ModelPart head_roman_muscular_forehead;
	private final ModelPart head_roman_muscular_muzzle;
	private final ModelPart head_roman_muscular_muzzle_individual;
	private final ModelPart head_roman_muscular_mouth;
	private final ModelPart head_roman_muscular_fringe;

	public head_roman_muscular(ModelPart root) {
		this.head_roman_muscular = root.getChild("head_roman_muscular");
		this.head_roman_muscular_jaw = this.head_roman_muscular.getChild("head_roman_muscular_jaw");
		this.head_jaw_individual = this.head_roman_muscular_jaw.getChild("head_jaw_individual");
		this.head_jaw_branch = this.head_roman_muscular_jaw.getChild("head_jaw_branch");
		this.head_roman_muscular_nose_bridge = this.head_roman_muscular.getChild("head_roman_muscular_nose_bridge");
		this.head_roman_muscular_forehead = this.head_roman_muscular.getChild("head_roman_muscular_forehead");
		this.head_roman_muscular_muzzle = this.head_roman_muscular.getChild("head_roman_muscular_muzzle");
		this.head_roman_muscular_muzzle_individual = this.head_roman_muscular_muzzle.getChild("head_roman_muscular_muzzle_individual");
		this.head_roman_muscular_mouth = this.head_roman_muscular_muzzle.getChild("head_roman_muscular_mouth");
		this.head_roman_muscular_fringe = this.head_roman_muscular.getChild("head_roman_muscular_fringe");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		head_roman_muscular.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}