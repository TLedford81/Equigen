...
public class neck_average_arched_short_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_arched_short_1(ModelPart root) {
		...
		this.headAnchor = this.neck_average_arched_short_1.getChild("headAnchor");
		this.chestAnchor = this.neck_average_arched_short_1.getChild("chestAnchor");
		this.withersAnchor = this.neck_average_arched_short_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = neck_average_arched_short_1_lower_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(383, 608).addBox(-5.08F, -11.0F, -0.92F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 8.0069F, 1.0273F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_arched_short_1_top_mane_flow.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(709, 770).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0256F, -1.0516F, 0.0323F, 0.0399F, -0.3352F));
		...
		PartDefinition headAnchor = neck_average_arched_short_1.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.25F, -6.1327F, -5.6739F));
		...
		PartDefinition withersAnchor = neck_average_arched_short_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.2F, -0.8346F, 1.6529F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_average_arched_short_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
