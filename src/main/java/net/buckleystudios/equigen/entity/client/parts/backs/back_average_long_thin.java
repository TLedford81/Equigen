...
public class back_average_long_thin<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "back_average_long_thin"), "main");
	private final ModelPart back_average_long_thin;
	private final ModelPart back_average_long_thin_back_ribs;
	private final ModelPart back_average_long_thin_back_top_lower;
	private final ModelPart back_average_long_thin_back_top_lower_individual;
	private final ModelPart back_average_long_thin_back_top_upper;

	public back_average_long_thin(ModelPart root) {
		this.back_average_long_thin = root.getChild("back_average_long_thin");
		this.back_average_long_thin_back_ribs = this.back_average_long_thin.getChild("back_average_long_thin_back_ribs");
		this.back_average_long_thin_back_top_lower = this.back_average_long_thin.getChild("back_average_long_thin_back_top_lower");
		this.back_average_long_thin_back_top_lower_individual = this.back_average_long_thin_back_top_lower.getChild("back_average_long_thin_back_top_lower_individual");
		this.back_average_long_thin_back_top_upper = this.back_average_long_thin_back_top_lower.getChild("back_average_long_thin_back_top_upper");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		back_average_long_thin.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}