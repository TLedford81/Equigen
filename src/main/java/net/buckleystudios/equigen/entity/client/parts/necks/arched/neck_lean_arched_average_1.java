...
public class neck_lean_arched_average_1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "neck_lean_arched_average_1"), "main");
	...
	private final ModelPart neck_lean_arched_average_1_middle_individual;
	private final ModelPart neck_lean_arched_average_1_lower_individual;
	private final ModelPart neck_lean_arched_average_1_mane;
	private final ModelPart neck_lean_arched_average_1_top_mane;
	private final ModelPart neck_lean_arched_average_1_top_mane_connector;
	private final ModelPart neck_lean_arched_average_1_top_mane_connector_individual;
	private final ModelPart neck_lean_arched_average_1_top_mane_connector2;
	private final ModelPart neck_lean_arched_average_1_top_mane_connector2_individual;
	private final ModelPart neck_lean_arched_average_1_top_mane_flow;
	private final ModelPart neck_lean_arched_average_1_bottom_mane;
	private final ModelPart neck_lean_arched_average_1_bottom_mane_connector;
	private final ModelPart neck_lean_arched_average_1_bottom_mane_connector_individual;
	private final ModelPart neck_lean_arched_average_1_bottom_mane_connector2;
	private final ModelPart neck_lean_arched_average_1_bottom_mane_connector2_individual;
	private final ModelPart neck_lean_arched_average_1_bottom_mane_flow;

	public neck_lean_arched_average_1(ModelPart root) {
		this.neck_lean_arched_average_1 = root.getChild("neck_lean_arched_average_1");
		this.neck_lean_arched_average_1_individual = this.neck_lean_arched_average_1.getChild("neck_lean_arched_average_1_individual");
		this.neck_lean_arched_average_1_crest = this.neck_lean_arched_average_1_individual.getChild("neck_lean_arched_average_1_crest");
		this.neck_lean_arched_average_1_crest_upper = this.neck_lean_arched_average_1_crest.getChild("neck_lean_arched_average_1_crest_upper");
		this.neck_lean_arched_average_1_crest_lower = this.neck_lean_arched_average_1_crest.getChild("neck_lean_arched_average_1_crest_lower");
		this.neck_lean_arched_average_1_middle_individual = this.neck_lean_arched_average_1_individual.getChild("neck_lean_arched_average_1_middle_individual");
		this.neck_lean_arched_average_1_lower_individual = this.neck_lean_arched_average_1_individual.getChild("neck_lean_arched_average_1_lower_individual");
		this.neck_lean_arched_average_1_mane = this.neck_lean_arched_average_1.getChild("neck_lean_arched_average_1_mane");
		this.neck_lean_arched_average_1_top_mane = this.neck_lean_arched_average_1_mane.getChild("neck_lean_arched_average_1_top_mane");
		this.neck_lean_arched_average_1_top_mane_connector = this.neck_lean_arched_average_1_top_mane.getChild("neck_lean_arched_average_1_top_mane_connector");
		this.neck_lean_arched_average_1_top_mane_connector_individual = this.neck_lean_arched_average_1_top_mane_connector.getChild("neck_lean_arched_average_1_top_mane_connector_individual");
		this.neck_lean_arched_average_1_top_mane_connector2 = this.neck_lean_arched_average_1_top_mane_connector.getChild("neck_lean_arched_average_1_top_mane_connector2");
		this.neck_lean_arched_average_1_top_mane_connector2_individual = this.neck_lean_arched_average_1_top_mane_connector2.getChild("neck_lean_arched_average_1_top_mane_connector2_individual");
		this.neck_lean_arched_average_1_top_mane_flow = this.neck_lean_arched_average_1_top_mane_connector2.getChild("neck_lean_arched_average_1_top_mane_flow");
		this.neck_lean_arched_average_1_bottom_mane = this.neck_lean_arched_average_1_mane.getChild("neck_lean_arched_average_1_bottom_mane");
		this.neck_lean_arched_average_1_bottom_mane_connector = this.neck_lean_arched_average_1_bottom_mane.getChild("neck_lean_arched_average_1_bottom_mane_connector");
		this.neck_lean_arched_average_1_bottom_mane_connector_individual = this.neck_lean_arched_average_1_bottom_mane_connector.getChild("neck_lean_arched_average_1_bottom_mane_connector_individual");
		this.neck_lean_arched_average_1_bottom_mane_connector2 = this.neck_lean_arched_average_1_bottom_mane_connector.getChild("neck_lean_arched_average_1_bottom_mane_connector2");
		this.neck_lean_arched_average_1_bottom_mane_connector2_individual = this.neck_lean_arched_average_1_bottom_mane_connector2.getChild("neck_lean_arched_average_1_bottom_mane_connector2_individual");
		this.neck_lean_arched_average_1_bottom_mane_flow = this.neck_lean_arched_average_1_bottom_mane_connector2.getChild("neck_lean_arched_average_1_bottom_mane_flow");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		neck_lean_arched_average_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}