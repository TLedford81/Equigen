...
public class neck_muscular_straight_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_straight_long_1(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_straight_long_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_muscular_straight_long_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0952F, 0.3837F, -3.6152F));
		...
		PartDefinition cube_r3 = neck_muscular_straight_long_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(614, 893).addBox(-4.08F, -5.0F, -0.92F, 4.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 0.4951F, 0.8725F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_muscular_straight_long_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(602, 879).addBox(-4.0F, -7.0F, -1.0F, 6.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9897F, 0.6818F, 2.0413F, 1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_muscular_straight_long_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(580, 877).addBox(-5.0708F, -11.03F, -0.9292F, 6.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0811F, 5.8277F, 2.5752F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_muscular_straight_long_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(598, 893).addBox(-5.0784F, -5.0F, -0.9017F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 1.7601F, 0.5988F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_muscular_straight_long_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(930, 934).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_muscular_straight_long_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(930, 941).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_muscular_straight_long_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(916, 935).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r11 = neck_muscular_straight_long_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(941, 931).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.3331F, -4.2549F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_muscular_straight_long_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(940, 943).addBox(-1.5F, -0.5F, -5.0F, 3.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8408F, 1.4624F, 0.1115F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_muscular_straight_long_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(918, 937).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -2.6816F, -1.8771F, -0.9753F, -0.1144F, -0.1002F));
