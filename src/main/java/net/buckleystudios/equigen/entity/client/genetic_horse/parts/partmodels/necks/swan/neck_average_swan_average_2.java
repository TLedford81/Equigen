...
public class neck_average_swan_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_swan_average_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_swan_average_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_swan_average_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0368F, -2.4114F, -4.6009F));
		...
		PartDefinition cube_r3 = neck_average_swan_average_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(537, 975).addBox(-4.08F, -12.0F, -0.92F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 6.1895F, 4.2363F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_swan_average_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(518, 960).addBox(-5.0F, -10.0F, -2.0F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.4971F, 3.5373F, 2.8271F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_average_swan_average_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(519, 975).addBox(-5.08F, -9.0F, -0.92F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5829F, 5.5745F, -0.4408F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_swan_average_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(538, 961).addBox(-4.8996F, -9.0F, -0.9017F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3996F, 4.1429F, -0.2065F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_swan_average_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(874, 973).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.9663F, 1.0647F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_swan_average_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(874, 981).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.3759F, 0.7779F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_swan_average_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(860, 975).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_average_swan_average_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(884, 972).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.5567F, -3.2223F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_swan_average_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(884, 984).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.2603F, -3.6251F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_swan_average_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(862, 978).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5363F, -0.4469F, 0.0894F, -0.8937F, -0.1201F, -0.1036F));
