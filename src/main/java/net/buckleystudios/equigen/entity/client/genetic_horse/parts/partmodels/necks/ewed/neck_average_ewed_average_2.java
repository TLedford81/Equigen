...
public class neck_average_ewed_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_ewed_average_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_ewed_average_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_ewed_average_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.038F, -2.016F, -3.0285F));
		...
		PartDefinition cube_r3 = neck_average_ewed_average_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(549, 744).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 2.0938F, 1.3684F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_ewed_average_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(532, 730).addBox(-4.0F, -8.0F, -1.0F, 5.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 3.031F, 0.9016F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = neck_average_ewed_average_2_lower_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(550, 730).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 3.182F, -0.2844F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_ewed_average_2_top_mane_connector_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(871, 844).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.3927F, 0.2456F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_ewed_average_2_top_mane_connector2_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(871, 850).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.8023F, -0.0412F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_ewed_average_2_top_mane_flow.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(859, 844).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, 0.1998F, -0.4712F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r10 = neck_average_ewed_average_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(883, 839).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.5567F, -3.2223F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_average_ewed_average_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(881, 851).addBox(-1.0F, -0.5F, -5.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.324F, -4.4436F, 2.7312F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_ewed_average_2_bottom_mane_flow.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(859, 845).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.2681F, 0.1788F, -0.8901F, -0.0927F, -0.1377F));
