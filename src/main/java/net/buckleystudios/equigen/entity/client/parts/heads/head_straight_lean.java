...
public class head_straight_lean<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "head_straight_lean"), "main");
	private final ModelPart head_straight_lean;
	private final ModelPart head_straight_lean_forehead;
	private final ModelPart head_straight_lean_nose_bridge;
	private final ModelPart head_straight_lean_jaw;
	private final ModelPart head_straight_lean_jaw_individual;
	private final ModelPart head_straight_lean_jaw_branch;
	private final ModelPart head_straight_lean_muzzle;
	private final ModelPart head_straight_lean_muzzle_individual;
	private final ModelPart head_straight_lean_mouth;
	private final ModelPart head_straight_lean_fringe;

	public head_straight_lean(ModelPart root) {
		this.head_straight_lean = root.getChild("head_straight_lean");
		this.head_straight_lean_forehead = this.head_straight_lean.getChild("head_straight_lean_forehead");
		this.head_straight_lean_nose_bridge = this.head_straight_lean.getChild("head_straight_lean_nose_bridge");
		this.head_straight_lean_jaw = this.head_straight_lean.getChild("head_straight_lean_jaw");
		this.head_straight_lean_jaw_individual = this.head_straight_lean_jaw.getChild("head_straight_lean_jaw_individual");
		this.head_straight_lean_jaw_branch = this.head_straight_lean_jaw.getChild("head_straight_lean_jaw_branch");
		this.head_straight_lean_muzzle = this.head_straight_lean.getChild("head_straight_lean_muzzle");
		this.head_straight_lean_muzzle_individual = this.head_straight_lean_muzzle.getChild("head_straight_lean_muzzle_individual");
		this.head_straight_lean_mouth = this.head_straight_lean_muzzle.getChild("head_straight_lean_mouth");
		this.head_straight_lean_fringe = this.head_straight_lean.getChild("head_straight_lean_fringe");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		head_straight_lean.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}