...
public class stomach_lean_short_low extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition stomach_lean_short_low_stomach_front_upper = stomach_lean_short_low.addOrReplaceChild("stomach_lean_short_low_stomach_front_upper", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -3.0223F));
		...
		PartDefinition cube_r3 = stomach_lean_short_low_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(423, 303).addBox(-5.0984F, -6.2952F, -5.4096F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5984F, -3.4959F, 0.191F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_lean_short_low_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(407, 303).addBox(-4.0792F, -6.2976F, -5.4648F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0792F, -3.5507F, 0.1838F, 1.7453F, 0.0F, 0.0F));
