...
public class EarsModelParts {
    public static PartDefinition[] Generate(PartDefinition leftEarRoot, PartDefinition rightEarRoot, String size) {
        if (true) {
            PartDefinition right_ear = rightEarRoot.addOrReplaceChild("right_ear", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
            ...
            PartDefinition left_ear = leftEarRoot.addOrReplaceChild("left_ear", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        return new PartDefinition[]{leftEarRoot, rightEarRoot};
    }
}
