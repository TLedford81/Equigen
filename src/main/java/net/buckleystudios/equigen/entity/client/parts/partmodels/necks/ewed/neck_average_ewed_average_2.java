...
public class neck_average_ewed_average_2 extends HierarchicalModel<GeneticHorseEntity> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_average_ewed_average_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
