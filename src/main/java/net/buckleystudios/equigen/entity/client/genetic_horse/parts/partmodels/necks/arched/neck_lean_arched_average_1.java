...
public class neck_lean_arched_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_arched_average_1(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_arched_average_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_arched_average_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0221F, -0.1998F, -3.379F));
		...
		PartDefinition cube_r4 = neck_lean_arched_average_1_middle_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(484, 584).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.1077F, 6.1456F, 0.2651F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r5 = neck_lean_arched_average_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(473, 571).addBox(-4.0F, -10.0F, -1.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9707F, 3.5644F, 3.1501F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = neck_lean_arched_average_1_lower_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(489, 572).addBox(-4.08F, -7.7191F, -1.7991F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 3.6074F, 0.9268F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_arched_average_1_top_mane_connector_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(819, 770).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0567F, 0.3652F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_arched_average_1_top_mane_connector2_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(819, 777).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.5524F, 0.2999F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_arched_average_1_top_mane_flow.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(805, 771).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, -1.0516F, 0.0323F, 0.0399F, -0.3352F));
		...
		PartDefinition cube_r10 = neck_lean_arched_average_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(828, 769).addBox(-2.0F, -2.0F, -2.01F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.3667F, -2.3092F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_lean_arched_average_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(828, 780).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.0702F, -2.7119F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_arched_average_1_bottom_mane_flow.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(808, 774).addBox(-0.8139F, -0.0002F, -5.3921F, 1.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0726F, 1.4302F, 1.2514F, -0.8937F, -0.1201F, -0.1036F));
