...
public class neck_average_ewed_short_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = neck_average_ewed_short_1_crest_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(366, 741).addBox(-3.08F, -4.0F, -2.92F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.08F, 1.1435F, -0.0323F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = neck_average_ewed_short_1_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(715, 858).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.8191F, -0.5736F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_average_ewed_short_1_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(715, 864).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.2287F, -0.8604F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_ewed_short_1_top_mane_flow.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(729, 829).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6257F, -0.4463F, -0.7381F, -0.4276F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r6 = neck_average_ewed_short_1_top_mane_flow_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(739, 829).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6007F, -0.0014F, 0.2833F, -0.5159F, -0.0327F, -0.0032F));
		...
		PartDefinition cube_r7 = neck_average_ewed_short_1_crest_lower.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(382, 741).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 3.3225F, 2.2288F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_ewed_short_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(727, 852).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.9534F, -3.5267F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_ewed_short_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(727, 861).addBox(-2.0F, -2.0F, 1.0F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.6569F, -3.9295F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_average_ewed_short_1_bottom_mane_flow.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(716, 843).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.8938F, -0.4469F, -0.8901F, -0.0927F, -0.1377F));
		...
		PartDefinition cube_r12 = neck_average_ewed_short_1_bottom_mane_flow_lower.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(739, 844).addBox(-0.8139F, -0.0002F, -1.3921F, 1.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1439F, -1.5514F, -0.7332F, -0.9171F, 0.0807F, -0.0051F));
		...
		PartDefinition cube_r13 = neck_average_ewed_short_1_middle_individual.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(362, 730).addBox(-4.0F, -8.0F, -1.0F, 5.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 4.2598F, 1.7619F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r14 = neck_average_ewed_short_1_lower_individual.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(380, 730).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 4.6309F, 0.1038F, 0.2618F, 0.0F, 0.0F));
