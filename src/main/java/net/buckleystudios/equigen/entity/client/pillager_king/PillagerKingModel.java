...
public class PillagerKingModel extends HierarchicalModel<PillagerKingEntity> {
     ...
     public void setupAnim(PillagerKingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
         ...
         this.animateWalk(PillagerKingAnimations.walking, limbSwing, limbSwingAmount, 2f, 2.5f);
         this.animate(entity.idleAnimationState, PillagerKingAnimations.idle, ageInTicks, 1);
     }
