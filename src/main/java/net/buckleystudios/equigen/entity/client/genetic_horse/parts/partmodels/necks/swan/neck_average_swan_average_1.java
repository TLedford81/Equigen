...
public class neck_average_swan_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_swan_average_1(ModelPart root) {
		...
		this.withersAnchor = this.neck_average_swan_average_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = neck_average_swan_average_1_lower_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(484, 965).addBox(-5.0784F, -9.0F, -0.9017F, 3.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5784F, 4.6311F, -0.0983F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition withersAnchor = neck_average_swan_average_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.3F, -1.8346F, 3.0528F));
