...
public class neck_average_arched_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = neck_average_arched_average_2_middle_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(529, 605).addBox(-5.0F, -10.0F, -1.0F, 5.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5783F, 3.1462F, 2.9086F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition withersAnchor = neck_average_arched_average_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.2F, -0.9346F, 2.5529F));
