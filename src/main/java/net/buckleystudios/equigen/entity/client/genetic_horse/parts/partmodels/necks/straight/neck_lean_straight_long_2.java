...
public class neck_lean_straight_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_straight_long_2(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_straight_long_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_straight_long_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0048F, 0.3669F, -3.3638F));
		...
		PartDefinition cube_r3 = neck_lean_straight_long_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(667, 831).addBox(-3.08F, -5.0F, -0.92F, 3.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 0.2838F, 0.4193F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_straight_long_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(657, 816).addBox(-3.0F, -7.0F, -1.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9897F, 0.4154F, 1.6232F, 1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_lean_straight_long_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(639, 814).addBox(-4.0708F, -11.03F, -0.9292F, 4.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0811F, 5.5613F, 2.1571F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_straight_long_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(653, 831).addBox(-4.0784F, -5.0F, -0.9017F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 1.76F, 0.5988F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition neck_lean_straight_long_2_top_mane = neck_lean_straight_long_2_mane.addOrReplaceChild("neck_lean_straight_long_2_top_mane", CubeListBuilder.create(), PartPose.offset(0.6201F, -3.0749F, -3.1208F));
		...
		PartDefinition cube_r8 = neck_lean_straight_long_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(988, 906).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_straight_long_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(988, 913).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_straight_long_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(974, 907).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));

		PartDefinition neck_lean_straight_long_2_bottom_mane = neck_lean_straight_long_2_mane.addOrReplaceChild("neck_lean_straight_long_2_bottom_mane", CubeListBuilder.create(), PartPose.offset(0.6201F, -0.1251F, -0.3498F));
		...
		PartDefinition cube_r11 = neck_lean_straight_long_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(997, 902).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.7427F, -4.5417F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_straight_long_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(991, 915).addBox(-2.0F, -2.0F, 1.0F, 2.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.4641F, -4.957F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_lean_straight_long_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(975, 908).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -2.6816F, -1.8771F, -0.9753F, -0.1144F, -0.1002F));
