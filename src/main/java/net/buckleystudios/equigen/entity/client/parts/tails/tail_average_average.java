...
//
//
//public class tail_average_average<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "tail_average_average"), "main");
//	private final ModelPart tail_average_average;
//	private final ModelPart tail_average_average_tail_connector;
//	private final ModelPart tail_average_average_tail_connector_rotator;
//	private final ModelPart tail_average_average_tail_top;
//	private final ModelPart tail_average_average_tail_top_individual;
//	private final ModelPart tail_average_average_tail_middle;
//	private final ModelPart tail_average_average_tail_middle_individual;
//	private final ModelPart tail_average_average_tail_bottom;
//
//	public tail_average_average(ModelPart root) {
//		this.tail_average_average = root.getChild("tail_average_average");
//		this.tail_average_average_tail_connector = this.tail_average_average.getChild("tail_average_average_tail_connector");
//		this.tail_average_average_tail_connector_rotator = this.tail_average_average_tail_connector.getChild("tail_average_average_tail_connector_rotator");
//		this.tail_average_average_tail_top = this.tail_average_average_tail_connector.getChild("tail_average_average_tail_top");
//		this.tail_average_average_tail_top_individual = this.tail_average_average_tail_top.getChild("tail_average_average_tail_top_individual");
//		this.tail_average_average_tail_middle = this.tail_average_average_tail_top.getChild("tail_average_average_tail_middle");
//		this.tail_average_average_tail_middle_individual = this.tail_average_average_tail_middle.getChild("tail_average_average_tail_middle_individual");
//		this.tail_average_average_tail_bottom = this.tail_average_average_tail_middle.getChild("tail_average_average_tail_bottom");
//	}
//
...
//		tail_average_average.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}