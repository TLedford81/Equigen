...
public class neck_average_ewed_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_ewed_long_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_ewed_long_2.getChild("headAnchor");
		this.chestAnchor = this.neck_average_ewed_long_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_average_ewed_long_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r7 = neck_average_ewed_long_2_top_mane_flow.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(978, 843).mirror().addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.8045F, 0.0256F, 0.1998F, -0.4712F, -0.2206F, -0.3514F));
		...
		PartDefinition headAnchor = neck_average_ewed_long_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.25F, -12.1327F, -6.9239F));
		...
		PartDefinition withersAnchor = neck_average_ewed_long_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.1F, -1.6346F, 2.5529F));
