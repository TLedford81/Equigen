...
public class neck_lean_ewed_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_ewed_average_2(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_ewed_average_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_ewed_average_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.009F, -2.016F, -2.9391F));
		...
		PartDefinition cube_r3 = neck_lean_ewed_average_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(549, 709).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 2.0938F, 1.3684F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_ewed_average_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(534, 695).addBox(-3.0F, -8.0F, -1.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 3.031F, 0.9016F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = neck_lean_ewed_average_2_lower_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(550, 695).addBox(-4.0784F, -8.0F, -0.9017F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 3.182F, -0.2844F, 0.2618F, 0.0F, 0.0F));

		PartDefinition neck_lean_ewed_average_2_mane = neck_lean_ewed_average_2.addOrReplaceChild("neck_lean_ewed_average_2_mane", CubeListBuilder.create(), PartPose.offset(0.0F, -7.6871F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_ewed_average_2_top_mane_connector_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(871, 844).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.3927F, 0.2456F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_ewed_average_2_top_mane_connector2_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(871, 850).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.8023F, -0.0412F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_ewed_average_2_top_mane_flow.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(859, 844).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, 0.1998F, -0.4712F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r10 = neck_lean_ewed_average_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(883, 839).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.5567F, -3.2223F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_lean_ewed_average_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(881, 851).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.2603F, -3.6251F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_ewed_average_2_bottom_mane_flow.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(859, 845).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.2681F, 0.1788F, -0.8901F, -0.0927F, -0.1377F));
