...
public class neck_lean_swan_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_swan_long_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.15F, -11.5327F, -8.4239F));
		...
		PartDefinition withersAnchor = neck_lean_swan_long_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.1F, -1.5346F, 3.4028F));
