...
public class back_leg_top_thick_average_2 extends MultipartBackTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top_back_legs_thick_average_2_top_back_right_individual = top_back_legs_thick_average_2.addOrReplaceChild("top_back_legs_thick_average_2_top_back_right_individual", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition top_back_legs_thick_average_2_top_back_left_individual = top_back_legs_thick_average_2.addOrReplaceChild("top_back_legs_thick_average_2_top_back_left_individual", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
