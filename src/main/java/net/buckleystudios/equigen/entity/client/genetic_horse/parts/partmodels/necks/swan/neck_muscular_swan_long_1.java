...
public class neck_muscular_swan_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_swan_long_1(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_swan_long_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_muscular_swan_long_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0269F, -2.3888F, -2.1498F));
		...
		PartDefinition cube_r3 = neck_muscular_swan_long_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(596, 1004).addBox(-5.08F, -12.0F, -0.92F, 5.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 5.78F, 3.9495F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_muscular_swan_long_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(576, 988).addBox(-4.0F, -10.0F, -2.0F, 6.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.162F, 1.7578F, 0.9547F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_muscular_swan_long_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(576, 1004).addBox(-5.08F, -9.0F, -0.92F, 6.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.2311F, 3.795F, -2.3133F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_muscular_swan_long_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(598, 989).addBox(-5.0784F, -9.0F, -0.9017F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 3.6547F, -0.3147F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition neck_muscular_swan_long_1_top_mane = neck_muscular_swan_long_1_mane.addOrReplaceChild("neck_muscular_swan_long_1_top_mane", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0559F, -2.1452F));
		...
		PartDefinition cube_r8 = neck_muscular_swan_long_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(927, 998).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.9663F, 1.0647F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_muscular_swan_long_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(927, 1006).addBox(-2.0F, -2.0F, -5.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 2.3759F, 0.7779F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_muscular_swan_long_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(911, 1000).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_muscular_swan_long_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(939, 995).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.9534F, -3.5267F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_muscular_swan_long_1_bottom_mane_connector_individual2.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(938, 1008).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -2.6569F, -3.9295F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_muscular_swan_long_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(914, 1002).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5363F, -0.6257F, -0.0894F, -0.8937F, -0.1201F, -0.1036F));
