...
public class neck_muscular_swan_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_swan_long_1(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_swan_long_1.getChild("headAnchor");
		this.chestAnchor = this.neck_muscular_swan_long_1.getChild("chestAnchor");
		this.withersAnchor = this.neck_muscular_swan_long_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = neck_muscular_swan_long_1_lower_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(598, 989).addBox(-5.0784F, -9.0F, -0.9017F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 3.6547F, -0.3147F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_muscular_swan_long_1_top_mane_flow.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(911, 1000).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition headAnchor = neck_muscular_swan_long_1.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.15F, -11.4327F, -8.9239F));
