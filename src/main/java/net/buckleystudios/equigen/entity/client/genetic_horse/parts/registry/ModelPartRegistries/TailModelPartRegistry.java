...
public class TailModelPartRegistry {
    ...
    public static void registerModels(){
        ModelPartRegistry.register(new ModelPartRegistryKeys.Tail(
                        Genetics.values.TAIL_THICKNESS.THIN,
                        Genetics.values.TAIL_LENGTH.SHORT
                ),
                ModModelLayers.TAIL_THIN_SHORT,
                tail_thin_short::new);
        ModelPartRegistry.register(new ModelPartRegistryKeys.Tail(
                        Genetics.values.TAIL_THICKNESS.THIN,
                        Genetics.values.TAIL_LENGTH.AVERAGE
                ),
                ModModelLayers.TAIL_THIN_AVERAGE,
                tail_thin_average::new);
        ModelPartRegistry.register(new ModelPartRegistryKeys.Tail(
                        Genetics.values.TAIL_THICKNESS.THIN,
                        Genetics.values.TAIL_LENGTH.LONG
                ),
                ModModelLayers.TAIL_THIN_LONG,
                tail_thin_long::new);
        ModelPartRegistry.register(new ModelPartRegistryKeys.Tail(
                        Genetics.values.TAIL_THICKNESS.AVERAGE,
                        Genetics.values.TAIL_LENGTH.SHORT
                ),
        ...
        ModelPartRegistry.register(new ModelPartRegistryKeys.Tail(
                        Genetics.values.TAIL_THICKNESS.THICK,
                        Genetics.values.TAIL_LENGTH.SHORT
                ),
