...
public class neck_muscular_arched_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_arched_average_1(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_arched_average_1.getChild("headAnchor");
		this.chestAnchor = this.neck_muscular_arched_average_1.getChild("chestAnchor");
		this.withersAnchor = this.neck_muscular_arched_average_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_muscular_arched_average_1.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.25F, -7.8827F, -5.9239F));
		...
		PartDefinition withersAnchor = neck_muscular_arched_average_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.2F, -1.0346F, 2.5529F));
