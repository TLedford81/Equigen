...
public class neck_average_arched_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_arched_long_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_arched_long_2.getChild("headAnchor");
		this.chestAnchor = this.neck_average_arched_long_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_average_arched_long_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_arched_long_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0F, -10.8827F, -7.9239F));
		...
		PartDefinition withersAnchor = neck_average_arched_long_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.1F, -0.8346F, 3.0529F));
