...
public class back_average_average_thick extends MultipartBackModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back_average_average_thick_back_ribs = back_average_average_thick.addOrReplaceChild("back_average_average_thick_back_ribs", CubeListBuilder.create().texOffs(101, 518).addBox(-3.5F, -3.9777F, -6.0F, 7.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0066F, -0.0223F, -0.071F));
		...
		PartDefinition stomachAnchor = back_average_average_thick.addOrReplaceChild("stomachAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 4.9F));
