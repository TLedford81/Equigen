...
//
//public class neck_average_arched_long_2<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "neck_average_arched_long_2"), "main");
...
//	private final ModelPart neck_average_arched_long_2_middle_individual;
//	private final ModelPart neck_average_arched_long_2_lower_individual;
//	private final ModelPart neck_average_arched_long_2_mane;
//	private final ModelPart neck_average_arched_long_2_top_mane;
//	private final ModelPart neck_average_arched_long_2_top_mane_connector;
//	private final ModelPart neck_average_arched_long_2_top_mane_connector_individual;
//	private final ModelPart neck_average_arched_long_2_top_mane_connector2;
//	private final ModelPart neck_average_arched_long_2_top_mane_connector2_individual;
//	private final ModelPart neck_average_arched_long_2_top_mane_flow;
//	private final ModelPart neck_average_arched_long_2_bottom_mane;
//	private final ModelPart neck_average_arched_long_2_bottom_mane_connector;
//	private final ModelPart neck_average_arched_long_2_bottom_mane_connector_individual;
//	private final ModelPart neck_average_arched_long_2_bottom_mane_connector2;
//	private final ModelPart neck_average_arched_long_2_bottom_mane_connector2_individual;
//	private final ModelPart neck_average_arched_long_2_bottom_mane_flow;
//
//	public neck_average_arched_long_2(ModelPart root) {
//		this.neck_average_arched_long_2 = root.getChild("neck_average_arched_long_2");
//		this.neck_average_arched_long_2_individual = this.neck_average_arched_long_2.getChild("neck_average_arched_long_2_individual");
//		this.neck_average_arched_long_2_crest = this.neck_average_arched_long_2_individual.getChild("neck_average_arched_long_2_crest");
//		this.neck_average_arched_long_2_crest_upper = this.neck_average_arched_long_2_crest.getChild("neck_average_arched_long_2_crest_upper");
//		this.neck_average_arched_long_2_crest_lower = this.neck_average_arched_long_2_crest.getChild("neck_average_arched_long_2_crest_lower");
//		this.neck_average_arched_long_2_middle_individual = this.neck_average_arched_long_2_individual.getChild("neck_average_arched_long_2_middle_individual");
//		this.neck_average_arched_long_2_lower_individual = this.neck_average_arched_long_2_individual.getChild("neck_average_arched_long_2_lower_individual");
//		this.neck_average_arched_long_2_mane = this.neck_average_arched_long_2.getChild("neck_average_arched_long_2_mane");
//		this.neck_average_arched_long_2_top_mane = this.neck_average_arched_long_2_mane.getChild("neck_average_arched_long_2_top_mane");
//		this.neck_average_arched_long_2_top_mane_connector = this.neck_average_arched_long_2_top_mane.getChild("neck_average_arched_long_2_top_mane_connector");
//		this.neck_average_arched_long_2_top_mane_connector_individual = this.neck_average_arched_long_2_top_mane_connector.getChild("neck_average_arched_long_2_top_mane_connector_individual");
//		this.neck_average_arched_long_2_top_mane_connector2 = this.neck_average_arched_long_2_top_mane_connector.getChild("neck_average_arched_long_2_top_mane_connector2");
//		this.neck_average_arched_long_2_top_mane_connector2_individual = this.neck_average_arched_long_2_top_mane_connector2.getChild("neck_average_arched_long_2_top_mane_connector2_individual");
//		this.neck_average_arched_long_2_top_mane_flow = this.neck_average_arched_long_2_top_mane_connector2.getChild("neck_average_arched_long_2_top_mane_flow");
//		this.neck_average_arched_long_2_bottom_mane = this.neck_average_arched_long_2_mane.getChild("neck_average_arched_long_2_bottom_mane");
//		this.neck_average_arched_long_2_bottom_mane_connector = this.neck_average_arched_long_2_bottom_mane.getChild("neck_average_arched_long_2_bottom_mane_connector");
//		this.neck_average_arched_long_2_bottom_mane_connector_individual = this.neck_average_arched_long_2_bottom_mane_connector.getChild("neck_average_arched_long_2_bottom_mane_connector_individual");
//		this.neck_average_arched_long_2_bottom_mane_connector2 = this.neck_average_arched_long_2_bottom_mane_connector.getChild("neck_average_arched_long_2_bottom_mane_connector2");
//		this.neck_average_arched_long_2_bottom_mane_connector2_individual = this.neck_average_arched_long_2_bottom_mane_connector2.getChild("neck_average_arched_long_2_bottom_mane_connector2_individual");
//		this.neck_average_arched_long_2_bottom_mane_flow = this.neck_average_arched_long_2_bottom_mane_connector2.getChild("neck_average_arched_long_2_bottom_mane_flow");
//	}
//
...
//		neck_average_arched_long_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}