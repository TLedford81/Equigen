...
public class TailModelParts {
    public static PartDefinition[] Generate(PartDefinition rootTail, PartDefinition rootTailConnector, PartDefinition rootTailConnectorRotator, PartDefinition rootTailTop, PartDefinition rootTailMiddle, PartDefinition rootTailBottom, String thickness, String length) {
        if (thickness.equals("thin") && length.equals("short")) {
            ...
            PartDefinition tail_top_thin_short = rootTailTop.addOrReplaceChild("tail_top_thin_short", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.162F, 0.5217F));
            ...
            PartDefinition tail_middle_thin_short = rootTailMiddle.addOrReplaceChild("tail_middle_thin_short", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0179F, -0.0147F));
            ...
            PartDefinition tail_bottom_thin_short = rootTailBottom.addOrReplaceChild("tail_bottom_thin_short", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, -0.0147F));
            ...
            PartDefinition tail_top_thin_average = rootTailTop.addOrReplaceChild("tail_top_thin_average", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.0726F, 0.7898F));
            ...
            PartDefinition tail_middle_thin_average = rootTailMiddle.addOrReplaceChild("tail_middle_thin_average", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0179F, -0.0147F));
            ...
            PartDefinition tail_bottom_thin_average = rootTailBottom.addOrReplaceChild("tail_bottom_thin_average", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, -0.0147F));
            ...
            PartDefinition tail_top_thin_long = rootTailTop.addOrReplaceChild("tail_top_thin_long", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.2514F, 0.611F));
            ...
            PartDefinition tail_middle_thin_long = rootTailMiddle.addOrReplaceChild("tail_middle_thin_long", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0179F, -0.0147F));
            ...
            PartDefinition tail_bottom_thin_long = rootTailBottom.addOrReplaceChild("tail_bottom_thin_long", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, -0.0147F));
            ...
            PartDefinition tail_top_thick_short = rootTailTop.addOrReplaceChild("tail_top_thick_short", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.2514F, 0.7898F));
            ...
            PartDefinition tail_middle_thick_short = rootTailMiddle.addOrReplaceChild("tail_middle_thick_short", CubeListBuilder.create(), PartPose.offset(-0.3575F, 0.0179F, 0.3429F));
            ...
            PartDefinition tail_bottom_thick_short = rootTailBottom.addOrReplaceChild("tail_bottom_thick_short", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, -0.0147F));
            ...
            PartDefinition tail_top_average_average = rootTailTop.addOrReplaceChild("tail_top_average_average", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.0726F, 0.4323F));
            ...
            PartDefinition tail_middle_average_average = rootTailMiddle.addOrReplaceChild("tail_middle_average_average", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0179F, -0.0147F));
            ...
            PartDefinition tail_bottom_average_average = rootTailBottom.addOrReplaceChild("tail_bottom_average_average", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, 0.2535F));
            ...
            PartDefinition tail_top_thick_long = rootTailTop.addOrReplaceChild("tail_top_thick_long", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.0726F, 0.4323F));
            ...
            PartDefinition tail_middle_thick_long = rootTailMiddle.addOrReplaceChild("tail_middle_thick_long", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0F, -0.0147F));
            ...
            PartDefinition tail_bottom_thick_long = rootTailBottom.addOrReplaceChild("tail_bottom_thick_long", CubeListBuilder.create(), PartPose.offset(0.1788F, -0.0179F, 0.0747F));
            ...
            PartDefinition tail_top_thick_short = rootTailTop.addOrReplaceChild("tail_top_thick_short", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.4302F, 0.611F));
            ...
            PartDefinition tail_top_thick_average = rootTailTop.addOrReplaceChild("tail_top_thick_average", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.162F, 0.611F));
            ...
            PartDefinition tail_middle_thick_average = rootTailMiddle.addOrReplaceChild("tail_middle_thick_average", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0179F, -0.0147F));
            ...
            PartDefinition tail_bottom_thick_average = rootTailBottom.addOrReplaceChild("tail_bottom_thick_average", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, -0.0147F));
            ...
            PartDefinition tail_top_thick_long = rootTailTop.addOrReplaceChild("tail_top_thick_long", CubeListBuilder.create(), PartPose.offset(0.4469F, -1.0726F, 0.5217F));

            PartDefinition cube_r2 = tail_top_thick_long.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(639, 82).addBox(-1.0F, -2.0785F, 0.1082F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.9832F, 0.8939F, -1.2514F, -1.3963F, 0.0F, 0.0F));

            PartDefinition tail_middle_thick_long = rootTailMiddle.addOrReplaceChild("tail_middle_thick_long", CubeListBuilder.create(), PartPose.offset(0.0894F, 0.0179F, 0.0F));

            PartDefinition cube_r3 = tail_middle_thick_long.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(636, 69).addBox(-1.0F, -0.9635F, -0.1495F, 5.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.6089F, -0.0179F, 1.3408F, -1.6144F, 0.0F, 0.0F));

            PartDefinition tail_bottom_thick_long = rootTailBottom.addOrReplaceChild("tail_bottom_thick_long", CubeListBuilder.create(), PartPose.offset(0.1788F, 0.0F, -0.0147F));

            PartDefinition cube_r4 = tail_bottom_thick_long.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(656, 77).addBox(-1.0F, -1.8391F, -0.9493F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7151F, 0.5363F, -0.5363F, -1.6144F, 0.0F, 0.0F));


        } else {
            EquigenMod.LOGGER.error("Invalid Part Generated: Tail / " + thickness + " / " + length + ", Returning Null Value");
            return null;
        }
        return new PartDefinition[]{rootTail, rootTailConnector, rootTailConnectorRotator, rootTailTop, rootTailMiddle, rootTailBottom};
    }
    public static PartDefinition[] GenerateAll(PartDefinition rootTail, PartDefinition rootTailConnector, PartDefinition rootTailConnectorRotator, PartDefinition rootTailTop, PartDefinition rootTailMiddle, PartDefinition rootTailBottom){
        ...
        for(String variable1 : TAIL_THICKNESS) {
            for(String variable2 : TAIL_LENGTH) {
                parts = Generate(rootTail, rootTailConnector, rootTailConnectorRotator, rootTailTop, rootTailMiddle, rootTailBottom, variable1, variable2);
                rootTail = parts[0];
                rootTailConnector = parts[1];
                rootTailConnectorRotator = parts[2];
                rootTailTop = parts[3];
                rootTailMiddle = parts[4];
                rootTailBottom = parts[5];
            }
        }
        return parts;
    }
