...
public class neck_average_ewed_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	private final ModelPart neck_average_ewed_short_2_individual;
	private final ModelPart neck_average_ewed_short_2_crest;
	private final ModelPart neck_average_ewed_short_2_crest_upper;
	private final ModelPart neck_average_ewed_short_2_crest_upper_individual;
	private final ModelPart neck_average_ewed_short_2_crest_lower;
	...
	public neck_average_ewed_short_2(ModelPart root) {
		...
		this.neck_average_ewed_short_2_individual = neck_average_ewed_short_2.getChild("neck_average_ewed_short_2_individual");
		this.neck_average_ewed_short_2_crest = neck_average_ewed_short_2_individual.getChild("neck_average_ewed_short_2_crest");
		this.neck_average_ewed_short_2_crest_upper = neck_average_ewed_short_2_crest.getChild("neck_average_ewed_short_2_crest_upper");
		this.neck_average_ewed_short_2_crest_upper_individual = neck_average_ewed_short_2_crest_upper.getChild("neck_average_ewed_short_2_crest_upper_individual");
		this.neck_average_ewed_short_2_crest_lower = neck_average_ewed_short_2_crest.getChild("neck_average_ewed_short_2_crest_lower");
		this.headAnchor = this.neck_average_ewed_short_2_crest_upper_individual.getChild("headAnchor");
		this.chestAnchor = this.neck_average_ewed_short_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_average_ewed_short_2_crest_lower.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_ewed_short_2_crest_upper_individual.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0547F, -1.9992F, -2.9936F));
		...
		PartDefinition neck_average_ewed_short_2_top_mane = neck_average_ewed_short_2_crest_upper.addOrReplaceChild("neck_average_ewed_short_2_top_mane", CubeListBuilder.create(), PartPose.offset(0.6366F, -1.947F, 1.7048F));

		PartDefinition neck_average_ewed_short_2_top_mane_connector = neck_average_ewed_short_2_top_mane.addOrReplaceChild("neck_average_ewed_short_2_top_mane_connector", CubeListBuilder.create(), PartPose.offset(-0.8045F, -0.4483F, -1.8771F));
		...
		PartDefinition cube_r3 = neck_average_ewed_short_2_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(772, 844).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.8192F, -0.5736F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_average_ewed_short_2_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(772, 850).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.2287F, -0.8604F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_ewed_short_2_top_mane_flow.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(760, 844).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.4276F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r6 = neck_average_ewed_short_2_crest_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(436, 742).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 2.9129F, 1.942F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition neck_average_ewed_short_2_bottom_mane = neck_average_ewed_short_2_crest_lower.addOrReplaceChild("neck_average_ewed_short_2_bottom_mane", CubeListBuilder.create(), PartPose.offset(0.564F, 1.9622F, 3.9234F));

		PartDefinition neck_average_ewed_short_2_bottom_mane_connector = neck_average_ewed_short_2_bottom_mane.addOrReplaceChild("neck_average_ewed_short_2_bottom_mane_connector", CubeListBuilder.create(), PartPose.offset(-0.8939F, -3.0F, -2.3031F));
		...
		PartDefinition cube_r11 = neck_average_ewed_short_2_middle_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(417, 730).addBox(-4.0F, -8.0F, -1.0F, 5.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 3.8502F, 1.4752F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_ewed_short_2_lower_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(435, 730).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 4.148F, -0.0256F, 0.2618F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart neck = this.neck_average_ewed_short_2;
		ModelPart individual = neck_average_ewed_short_2_individual;
		ModelPart crest = neck_average_ewed_short_2_crest;
		ModelPart crest_upper = neck_average_ewed_short_2_crest_upper;
		ModelPart crest_upper_individual = neck_average_ewed_short_2_crest_upper_individual;
		ModelPart crest_lower = neck_average_ewed_short_2_crest_lower;
