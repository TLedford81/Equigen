...
public class neck_average_ewed_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_ewed_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_ewed_short_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_ewed_short_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0547F, -1.9992F, -2.9936F));
		...
		PartDefinition cube_r3 = neck_average_ewed_short_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(436, 742).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 2.9129F, 1.942F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_ewed_short_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(417, 730).addBox(-4.0F, -8.0F, -1.0F, 5.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 3.8502F, 1.4752F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = neck_average_ewed_short_2_lower_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(435, 730).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 4.148F, -0.0256F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_ewed_short_2_top_mane_connector_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(772, 844).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.8192F, -0.5736F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_ewed_short_2_top_mane_connector2_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(772, 850).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.2287F, -0.8604F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_ewed_short_2_top_mane_flow.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(760, 844).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.4276F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r10 = neck_average_ewed_short_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(780, 843).addBox(-2.0F, -2.0F, -0.01F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.5567F, -3.2223F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_average_ewed_short_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(780, 853).addBox(-2.0F, -2.0F, 0.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.2603F, -3.6251F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_ewed_short_2_bottom_mane_flow.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(762, 847).addBox(-0.8139F, -0.0002F, -3.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.2682F, 0.0F, -0.8901F, -0.0927F, -0.1377F));
