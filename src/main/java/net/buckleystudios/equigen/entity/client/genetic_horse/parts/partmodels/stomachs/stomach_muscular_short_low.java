...
public class stomach_muscular_short_low extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = stomach_muscular_short_low_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(409, 462).addBox(-7.0984F, -6.2952F, -5.4096F, 7.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5984F, -3.4959F, 0.1911F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_muscular_short_low_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(391, 462).addBox(-5.08F, -6.24F, -5.52F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, -3.595F, 0.1175F, 1.7453F, 0.0F, 0.0F));
