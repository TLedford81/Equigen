...
public class head_dished_muscular extends MultipartHeadModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head_dished_muscular_forehead.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(1004, 118).addBox(-3.08F, -4.0F, -1.92F, 6.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.08F, -1.7583F, 1.0415F, 2.3998F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = head_dished_muscular_nose_bridge.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(988, 109).addBox(-3.08F, -3.24F, -1.84F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.08F, -0.8028F, -0.1369F, 2.8798F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = head_dished_muscular_jaw_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(982, 117).addBox(-3.9555F, -0.7109F, -1.1891F, 6.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9554F, 0.0154F, -1.1314F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = head_dished_muscular_jaw_branch.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(1004, 111).addBox(-3.0799F, -3.2418F, -1.8382F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0799F, -1.1189F, 0.0295F, 2.2689F, 0.0F, 0.0F));
