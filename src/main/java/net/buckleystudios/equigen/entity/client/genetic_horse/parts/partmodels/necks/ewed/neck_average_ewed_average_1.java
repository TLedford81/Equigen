...
public class neck_average_ewed_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_ewed_average_1(ModelPart root) {
		...
		this.headAnchor = this.neck_average_ewed_average_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_ewed_average_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.2167F, -1.8735F, -2.8148F));
		...
		PartDefinition cube_r3 = neck_average_ewed_average_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(494, 743).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 2.5033F, 1.6552F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_ewed_average_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(477, 730).addBox(-4.0F, -8.0F, -1.0F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 3.4406F, 1.1884F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = neck_average_ewed_average_1_lower_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(495, 730).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 3.665F, -0.155F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_ewed_average_1_top_mane_connector_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(820, 844).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.3927F, 0.2456F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_ewed_average_1_top_mane_connector2_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(820, 850).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.8023F, -0.0412F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_ewed_average_1_top_mane_flow.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(807, 844).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, 0.1998F, -0.4712F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r10 = neck_average_ewed_average_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(828, 841).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.16F, -2.9179F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_average_ewed_average_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(828, 852).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.8636F, -3.3207F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_ewed_average_1_bottom_mane_flow.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(808, 846).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.2682F, 0.1788F, -0.8901F, -0.0927F, -0.1377F));
