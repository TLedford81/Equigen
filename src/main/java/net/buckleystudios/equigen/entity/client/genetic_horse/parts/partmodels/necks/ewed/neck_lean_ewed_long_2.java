...
public class neck_lean_ewed_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_ewed_long_2_crest_upper_individual.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.009F, -1.3889F, -2.8847F));
		...
		PartDefinition cube_r3 = neck_lean_ewed_long_2_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(993, 841).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.3927F, 0.2456F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_lean_ewed_long_2_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(990, 849).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.8023F, -0.0412F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_ewed_long_2_top_mane_flow.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(978, 843).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0256F, 0.1998F, -0.4712F, -0.2206F, -0.3514F));
		...
		PartDefinition cube_r6 = neck_lean_ewed_long_2_crest_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(661, 711).addBox(-4.08F, -7.0F, -0.92F, 4.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 1.2746F, 0.7948F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_lean_ewed_long_2_middle_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(645, 695).addBox(-3.0F, -8.0F, -1.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.2119F, 0.328F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_ewed_long_2_lower_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(661, 695).addBox(-4.0784F, -8.0F, -0.9017F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 2.2161F, -0.5432F, 0.2618F, 0.0F, 0.0F));
