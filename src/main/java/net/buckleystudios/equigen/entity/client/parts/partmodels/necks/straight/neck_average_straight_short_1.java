...
public class neck_average_straight_short_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition withersAnchor = neck_average_straight_short_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.1F, -0.7346F, 2.0529F));
