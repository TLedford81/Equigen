...
public class neck_muscular_arched_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	private final ModelPart neck_muscular_arched_long_2_crest_upper_individual;
	...
	public neck_muscular_arched_long_2(ModelPart root) {
		...
		this.neck_muscular_arched_long_2_crest_upper_individual = neck_muscular_arched_long_2_crest_upper.getChild("neck_muscular_arched_long_2_crest_upper_individual");
		...
		this.headAnchor = this.neck_muscular_arched_long_2_crest_upper_individual.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition neck_muscular_arched_long_2_crest_upper = neck_muscular_arched_long_2_crest.addOrReplaceChild("neck_muscular_arched_long_2_crest_upper", CubeListBuilder.create(), PartPose.offset(-0.1827F, -2.7115F, -2.3756F));

		PartDefinition neck_muscular_arched_long_2_crest_upper_individual = neck_muscular_arched_long_2_crest_upper.addOrReplaceChild("neck_muscular_arched_long_2_crest_upper_individual", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = neck_muscular_arched_long_2_crest_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(105, 80).addBox(-4.1434F, -5.8622F, -2.7188F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.6434F, 0.8371F, 2.7002F, 1.5708F, 0.0F, 0.0F));

		PartDefinition headAnchor = neck_muscular_arched_long_2_crest_upper_individual.addOrReplaceChild("headAnchor", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0827F, 0.5766F, -3.194F));

		PartDefinition neck_muscular_arched_long_2_top_mane = neck_muscular_arched_long_2_crest_upper.addOrReplaceChild("neck_muscular_arched_long_2_top_mane", CubeListBuilder.create(), PartPose.offsetAndRotation(0.7135F, -1.077F, 1.3728F, 0.1309F, 0.0F, 0.0F));

		PartDefinition neck_muscular_arched_long_2_top_mane_connector = neck_muscular_arched_long_2_top_mane.addOrReplaceChild("neck_muscular_arched_long_2_top_mane_connector", CubeListBuilder.create(), PartPose.offset(-0.7151F, -0.3535F, -1.2808F));
		...
		PartDefinition cube_r2 = neck_muscular_arched_long_2_top_mane_connector_individual.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(96, 71).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0567F, 0.3652F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = neck_muscular_arched_long_2_top_mane_connector2_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(93, 53).addBox(-2.0F, -2.0F, -3.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 1.5524F, 0.2999F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_muscular_arched_long_2_top_mane_flow.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(112, 108).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, -1.0516F, 0.0323F, 0.0399F, -0.3352F));

		PartDefinition neck_muscular_arched_long_2_top_mane_flow_lower = neck_muscular_arched_long_2_top_mane_flow.addOrReplaceChild("neck_muscular_arched_long_2_top_mane_flow_lower", CubeListBuilder.create(), PartPose.offset(2.2743F, 6.6216F, 0.2412F));

		PartDefinition cube_r5 = neck_muscular_arched_long_2_top_mane_flow_lower.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(83, 108).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, -1.0516F, 0.0428F, 0.0284F, -0.0298F));
		...
		PartDefinition cube_r6 = neck_muscular_arched_long_2_crest_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(108, 60).addBox(-5.08F, -10.0F, -0.92F, 5.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 2.5314F, 2.4183F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition neck_muscular_arched_long_2_bottom_mane = neck_muscular_arched_long_2_crest_lower.addOrReplaceChild("neck_muscular_arched_long_2_bottom_mane", CubeListBuilder.create(), PartPose.offsetAndRotation(0.6764F, 3.1986F, 5.8538F, 0.1309F, 0.0F, 0.0F));

		PartDefinition neck_muscular_arched_long_2_bottom_mane_connector = neck_muscular_arched_long_2_bottom_mane.addOrReplaceChild("neck_muscular_arched_long_2_bottom_mane_connector", CubeListBuilder.create(), PartPose.offset(0.0F, -4.9927F, -4.6012F));
		...
		PartDefinition cube_r8 = neck_muscular_arched_long_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(87, 26).addBox(-2.0F, -2.0F, -2.01F, 2.0F, 2.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.9534F, -3.5267F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_muscular_arched_long_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(85, 6).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -2.657F, -3.9295F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_muscular_arched_long_2_bottom_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(96, 108).addBox(-0.8139F, -0.0002F, -5.3921F, 1.0F, 7.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0726F, -0.8045F, -0.3575F, -0.9199F, -0.1201F, -0.1036F));
		...
		PartDefinition cube_r11 = neck_muscular_arched_long_2_bottom_mane_flow_lower.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(67, 108).addBox(-0.8139F, -0.0002F, -5.3921F, 1.0F, 7.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0726F, -0.8045F, -0.3575F, -0.9243F, 0.054F, 0.0281F));
		...
		PartDefinition cube_r12 = neck_muscular_arched_long_2_middle_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(107, 43).addBox(-5.0784F, -9.0F, -0.9017F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.1161F, 5.8494F, 0.0543F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r13 = neck_muscular_arched_long_2_middle_individual.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(105, 21).addBox(-6.0F, -10.0F, -1.0F, 6.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9623F, 1.4805F, 1.6879F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r14 = neck_muscular_arched_long_2_lower_individual.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(105, 2).addBox(-6.0792F, -11.0F, -0.9108F, 6.0F, 12.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(3.0792F, 5.0961F, 0.4647F, 0.3054F, 0.0F, 0.0F));
	...
	protected void defineAnchorPaths() {
		...
		ModelPart crest_upper_individual = neck_muscular_arched_long_2_crest_upper_individual;
	...
	public Part getCubeDimensions() {
		return new Part("neck_muscular_arched_long_2", new ArrayList<>(
				Arrays.asList(
						new Block(5, 4, 4),
						new Block(5, 13, 2),
						new Block(6, 13, 4),
