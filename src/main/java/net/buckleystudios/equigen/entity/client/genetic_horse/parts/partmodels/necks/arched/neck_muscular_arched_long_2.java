...
public class neck_muscular_arched_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_arched_long_2(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_arched_long_2.getChild("headAnchor");
		this.chestAnchor = this.neck_muscular_arched_long_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_muscular_arched_long_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = neck_muscular_arched_long_2_middle_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(656, 667).addBox(-5.0784F, -9.0F, -0.9017F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.1161F, 5.8494F, 0.0543F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r4 = neck_muscular_arched_long_2_middle_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(642, 650).addBox(-6.0F, -10.0F, -1.0F, 6.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9623F, 1.4805F, 1.6879F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_muscular_arched_long_2_lower_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(662, 651).addBox(-6.0792F, -11.0F, -0.9108F, 6.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0792F, 5.0961F, 0.4647F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition headAnchor = neck_muscular_arched_long_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.1F, -10.8827F, -7.9239F));
		...
		PartDefinition withersAnchor = neck_muscular_arched_long_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.1F, -0.8346F, 3.0528F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_muscular_arched_long_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
