...
public class hips_lean_large_1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "hips_lean_large_1"), "main");
	private final ModelPart hips_lean_large_1;
	private final ModelPart hips_lean_large_1_left_hip;
	private final ModelPart hips_lean_large_1_left_hip_glute_base;
	private final ModelPart hips_lean_large_1_left_hip_glute_base_individual;
	private final ModelPart hips_lean_large_1_left_hip_glute_outer;
	private final ModelPart hips_lean_large_1_right_hip;
	private final ModelPart hips_lean_large_1_right_hip_glute_base;
	private final ModelPart hips_lean_large_1_right_hip_glue_base_individual;
	private final ModelPart hips_lean_large_1_right_hip_glue_outer;
	private final ModelPart hips_lean_large_1_hips_top;
	private final ModelPart hips_lean_large_1_hips_top_upper;
	private final ModelPart hips_lean_large_1_hips_top_lower;

	public hips_lean_large_1(ModelPart root) {
		this.hips_lean_large_1 = root.getChild("hips_lean_large_1");
		this.hips_lean_large_1_left_hip = this.hips_lean_large_1.getChild("hips_lean_large_1_left_hip");
		this.hips_lean_large_1_left_hip_glute_base = this.hips_lean_large_1_left_hip.getChild("hips_lean_large_1_left_hip_glute_base");
		this.hips_lean_large_1_left_hip_glute_base_individual = this.hips_lean_large_1_left_hip_glute_base.getChild("hips_lean_large_1_left_hip_glute_base_individual");
		this.hips_lean_large_1_left_hip_glute_outer = this.hips_lean_large_1_left_hip_glute_base.getChild("hips_lean_large_1_left_hip_glute_outer");
		this.hips_lean_large_1_right_hip = this.hips_lean_large_1.getChild("hips_lean_large_1_right_hip");
		this.hips_lean_large_1_right_hip_glute_base = this.hips_lean_large_1_right_hip.getChild("hips_lean_large_1_right_hip_glute_base");
		this.hips_lean_large_1_right_hip_glue_base_individual = this.hips_lean_large_1_right_hip_glute_base.getChild("hips_lean_large_1_right_hip_glue_base_individual");
		this.hips_lean_large_1_right_hip_glue_outer = this.hips_lean_large_1_right_hip_glute_base.getChild("hips_lean_large_1_right_hip_glue_outer");
		this.hips_lean_large_1_hips_top = this.hips_lean_large_1.getChild("hips_lean_large_1_hips_top");
		this.hips_lean_large_1_hips_top_upper = this.hips_lean_large_1_hips_top.getChild("hips_lean_large_1_hips_top_upper");
		this.hips_lean_large_1_hips_top_lower = this.hips_lean_large_1_hips_top.getChild("hips_lean_large_1_hips_top_lower");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		hips_lean_large_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}