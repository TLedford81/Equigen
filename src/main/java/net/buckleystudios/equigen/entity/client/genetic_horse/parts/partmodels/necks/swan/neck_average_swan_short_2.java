...
public class neck_average_swan_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_swan_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_swan_short_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_swan_short_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.2132F, -2.415F, -4.7761F));
		...
		PartDefinition cube_r3 = neck_average_swan_short_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(426, 980).addBox(-4.08F, -12.0F, -0.92F, 4.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 7.0087F, 4.8099F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_swan_short_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(408, 967).addBox(-5.0F, -10.0F, -2.0F, 5.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5055F, 4.4419F, 3.2252F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_average_swan_short_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(408, 980).addBox(-6.08F, -9.0F, -0.92F, 5.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5745F, 6.4792F, -0.0428F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_swan_short_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(428, 968).addBox(-5.0784F, -9.0F, -0.9017F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5784F, 5.1192F, 0.0099F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_swan_short_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(772, 973).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.9663F, 1.0647F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_swan_short_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(772, 981).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.3759F, 0.7779F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_swan_short_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(756, 975).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_average_swan_short_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(782, 976).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.7634F, -2.6136F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_swan_short_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(780, 986).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.4669F, -3.0163F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_swan_short_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(762, 980).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5363F, 0.1788F, 0.4469F, -0.8937F, -0.1201F, -0.1036F));
