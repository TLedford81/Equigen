...
public class neck_average_swan_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_swan_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_swan_short_2.getChild("headAnchor");
		this.chestAnchor = this.neck_average_swan_short_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_average_swan_short_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r8 = neck_average_swan_short_2_top_mane_flow.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(756, 975).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4085F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition headAnchor = neck_average_swan_short_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0F, -8.8827F, -6.1739F));
		...
		PartDefinition withersAnchor = neck_average_swan_short_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.2F, -1.8346F, 3.2529F));
