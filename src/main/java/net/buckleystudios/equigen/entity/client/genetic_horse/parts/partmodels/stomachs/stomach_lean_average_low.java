...
public class stomach_lean_average_low extends MultipartStomachModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition stomach_lean_average_low_stomach_front_lower = stomach_lean_average_low_stomach_front_upper.addOrReplaceChild("stomach_lean_average_low_stomach_front_lower", CubeListBuilder.create(), PartPose.offset(0.0026F, -0.5018F, -0.6967F));
		...
		PartDefinition cube_r3 = stomach_lean_average_low_stomach_back_upper_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(554, 303).addBox(-5.0984F, -6.2952F, -5.4096F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5984F, -3.4959F, 0.191F, 1.7453F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = stomach_lean_average_low_stomach_back_lower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(538, 303).addBox(-4.08F, -6.24F, -5.52F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, -3.595F, 0.1175F, 1.7453F, 0.0F, 0.0F));
