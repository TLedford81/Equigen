...
public class head_dished_muscular<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "head_dished_muscular"), "main");
	private final ModelPart head_dished_muscular;
	private final ModelPart head_dished_muscular_jaw;
	private final ModelPart head_dished_muscular_jaw_individual;
	private final ModelPart head_dished_muscular_jaw_branch;
	private final ModelPart head_dished_muscular_nose_bridge;
	private final ModelPart head_dished_muscular_forehead;
	private final ModelPart head_dished_muscular_muzzle;
	private final ModelPart head_dished_muscular_muzzle_individual;
	private final ModelPart head_dished_muscular_mouth;
	private final ModelPart head_dished_muscular_fringe;

	public head_dished_muscular(ModelPart root) {
		this.head_dished_muscular = root.getChild("head_dished_muscular");
		this.head_dished_muscular_jaw = this.head_dished_muscular.getChild("head_dished_muscular_jaw");
		this.head_dished_muscular_jaw_individual = this.head_dished_muscular_jaw.getChild("head_dished_muscular_jaw_individual");
		this.head_dished_muscular_jaw_branch = this.head_dished_muscular_jaw.getChild("head_dished_muscular_jaw_branch");
		this.head_dished_muscular_nose_bridge = this.head_dished_muscular.getChild("head_dished_muscular_nose_bridge");
		this.head_dished_muscular_forehead = this.head_dished_muscular.getChild("head_dished_muscular_forehead");
		this.head_dished_muscular_muzzle = this.head_dished_muscular.getChild("head_dished_muscular_muzzle");
		this.head_dished_muscular_muzzle_individual = this.head_dished_muscular_muzzle.getChild("head_dished_muscular_muzzle_individual");
		this.head_dished_muscular_mouth = this.head_dished_muscular_muzzle.getChild("head_dished_muscular_mouth");
		this.head_dished_muscular_fringe = this.head_dished_muscular.getChild("head_dished_muscular_fringe");
	}
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		head_dished_muscular.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}