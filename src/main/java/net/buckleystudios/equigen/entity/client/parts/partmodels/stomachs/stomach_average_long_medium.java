...
//
//
//public class stomach_average_long_medium<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "stomach_average_long_medium"), "main");
//	private final ModelPart stomach_average_long_medium;
//	private final ModelPart stomach_average_long_medium_stomach_front_upper;
//	private final ModelPart stomach_average_long_medium_stomach_front_upper_individual;
//	private final ModelPart stomach_average_long_medium_stomach_front_lower;
//	private final ModelPart stomach_average_long_medium_stomach_back_upper;
//	private final ModelPart stomach_average_long_medium_stomach_back_upper_individual;
//	private final ModelPart stomach_average_long_medium_stomach_back_lower;
//
...
//		this.stomach_average_long_medium_stomach_front_upper = this.stomach_average_long_medium.getChild("stomach_average_long_medium_stomach_front_upper");
//		this.stomach_average_long_medium_stomach_front_upper_individual = this.stomach_average_long_medium_stomach_front_upper.getChild("stomach_average_long_medium_stomach_front_upper_individual");
//		this.stomach_average_long_medium_stomach_front_lower = this.stomach_average_long_medium_stomach_front_upper.getChild("stomach_average_long_medium_stomach_front_lower");
//		this.stomach_average_long_medium_stomach_back_upper = this.stomach_average_long_medium.getChild("stomach_average_long_medium_stomach_back_upper");
//		this.stomach_average_long_medium_stomach_back_upper_individual = this.stomach_average_long_medium_stomach_back_upper.getChild("stomach_average_long_medium_stomach_back_upper_individual");
//		this.stomach_average_long_medium_stomach_back_lower = this.stomach_average_long_medium_stomach_back_upper.getChild("stomach_average_long_medium_stomach_back_lower");
//	}
//
...
//
//		PartDefinition stomach_average_long_medium = partdefinition.addOrReplaceChild("stomach_average_long_medium", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 2.5028F));
//
...
//		stomach_average_long_medium.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}