...
public class neck_average_ewed_long_1 extends HierarchicalModel<GeneticHorseEntity> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_average_ewed_long_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
