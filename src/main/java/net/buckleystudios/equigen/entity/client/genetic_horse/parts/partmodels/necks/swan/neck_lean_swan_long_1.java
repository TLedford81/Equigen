...
public class neck_lean_swan_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_swan_long_1(ModelPart root) {
		...
		this.headAnchor = this.neck_lean_swan_long_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_lean_swan_long_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0269F, -2.2463F, -4.9039F));
		...
		PartDefinition cube_r3 = neck_lean_swan_long_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(595, 939).addBox(-3.08F, -12.0F, -0.92F, 3.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 5.78F, 3.9495F, 0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_swan_long_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(579, 923).addBox(-4.0F, -10.0F, -2.0F, 4.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0055F, 3.0849F, 2.6281F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_lean_swan_long_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(579, 939).addBox(-5.08F, -9.0F, -0.92F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0745F, 5.1222F, -0.6399F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_lean_swan_long_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(597, 924).addBox(-5.0784F, -9.0F, -0.9017F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5784F, 3.6547F, -0.3147F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_lean_swan_long_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(931, 970).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3575F, -6.9721F, -2.0559F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_swan_long_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(931, 978).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.2346F, -7.0615F, -2.0559F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_swan_long_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(915, 972).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4086F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_lean_swan_long_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(941, 967).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3674F, -6.6079F, -0.8832F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_lean_swan_long_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(942, 980).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.324F, -6.7039F, -0.8939F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_lean_swan_long_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(918, 974).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5363F, -0.6257F, -0.0894F, -0.8937F, -0.1201F, -0.1036F));
