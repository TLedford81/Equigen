...
public class neck_lean_swan_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_lean_swan_long_1(ModelPart root) {
		...
		this.withersAnchor = this.neck_lean_swan_long_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = neck_lean_swan_long_1_lower_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(597, 924).addBox(-5.0784F, -9.0F, -0.9017F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5784F, 3.6547F, -0.3147F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition withersAnchor = neck_lean_swan_long_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.3F, -1.9346F, 3.1029F));
