...
public class back_leg_top_thick_short_2 extends MultipartBackTopLegModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top_back_legs_thick_short_2_top_back_right_individual = top_back_legs_thick_short_2.addOrReplaceChild("top_back_legs_thick_short_2_top_back_right_individual", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition top_back_legs_right_short_2_top_back_left_individual = top_back_legs_thick_short_2.addOrReplaceChild("top_back_legs_right_short_2_top_back_left_individual", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		top_back_legs_thick_short_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
