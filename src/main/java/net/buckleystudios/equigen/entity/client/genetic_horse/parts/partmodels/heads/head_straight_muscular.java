...
public class head_straight_muscular extends MultipartHeadModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head_straight_muscular_forehead.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(878, 112).addBox(-3.08F, -4.0F, -1.92F, 6.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.08F, -1.5507F, 1.331F, 2.2253F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = head_straight_muscular_nose_bridge.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(864, 112).addBox(-3.08F, -3.24F, -1.84F, 4.0F, 6.0F, 3.0F, new CubeDeformation(0.06F)), PartPose.offsetAndRotation(1.08F, -0.4158F, -0.0166F, 2.2253F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = head_jaw_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(862, 105).addBox(-3.9595F, -1.919F, -2.081F, 6.0F, 3.0F, 4.0F, new CubeDeformation(0.09F)), PartPose.offsetAndRotation(0.9595F, 0.366F, 0.2194F, 0.3491F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = head_jaw_branch.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(882, 103).addBox(-3.0708F, -3.2124F, -1.8584F, 4.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0708F, -0.4012F, 0.1124F, 1.8326F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = head_straight_muscular_fringe.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(880, 16).addBox(-1.0F, -2.0F, -2.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0894F, 0.3218F, -1.8441F, -1.5333F, 0.6643F, -1.5315F));
		...
		PartDefinition cube_r6 = head_straight_muscular_muzzle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(881, 119).addBox(-1.4469F, -1.7862F, -3.7184F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.07F)), PartPose.offsetAndRotation(-0.4627F, -0.8045F, 0.2118F, 0.7418F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = head_straight_muscular_mouth.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(881, 99).addBox(-1.9832F, -0.6095F, -3.149F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.05F)), PartPose.offsetAndRotation(0.088F, -0.3612F, 0.5648F, 0.829F, 0.0F, 0.0F));
