...
public class neck_average_straight_short_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_straight_short_1(ModelPart root) {
		...
		this.headAnchor = this.neck_average_straight_short_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = neck_average_straight_short_1_crest_upper.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(352, 862).addBox(-3.08F, -4.0F, -3.92F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.58F, -0.9328F, 0.5736F, 1.6144F, 0.0F, 0.0F));

		PartDefinition headAnchor = neck_average_straight_short_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0315F, 0.1688F, -3.4303F));
		...
		PartDefinition cube_r3 = neck_average_straight_short_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(386, 862).addBox(-4.08F, -5.0F, -0.92F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 1.129F, 2.232F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_straight_short_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(357, 851).addBox(-5.0708F, -11.03F, -0.9292F, 5.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5811F, 6.8804F, 4.3189F, 0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_average_straight_short_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(375, 852).addBox(-4.0F, -7.0F, -1.0F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4897F, 1.3769F, 3.9638F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_straight_short_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(370, 862).addBox(-5.0784F, -5.0F, -0.9017F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 2.3336F, 1.4179F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_straight_short_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(722, 933).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_straight_short_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(724, 940).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_straight_short_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(710, 934).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r11 = neck_average_straight_short_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(736, 940).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.6948F, -3.1077F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_straight_short_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(724, 947).addBox(-2.0F, -2.0F, 1.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -2.4163F, -3.523F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_straight_short_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(716, 940).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.2681F, 0.0F, -0.9774F, -0.0927F, -0.1377F));
