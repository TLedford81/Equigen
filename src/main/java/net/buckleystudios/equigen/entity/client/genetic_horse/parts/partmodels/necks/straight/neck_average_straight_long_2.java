...
public class neck_average_straight_long_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_straight_long_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_straight_long_2_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_straight_long_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0421F, 0.1881F, -3.4532F));
		...
		PartDefinition cube_r3 = neck_average_straight_long_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(668, 862).addBox(-4.08F, -5.0F, -0.92F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 0.2838F, 0.4193F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_straight_long_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(656, 847).addBox(-4.0F, -7.0F, -1.0F, 5.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4897F, 0.4154F, 1.6232F, 1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_average_straight_long_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(636, 845).addBox(-5.0708F, -11.03F, -0.9292F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5811F, 5.5613F, 2.1571F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_straight_long_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(652, 862).addBox(-5.0784F, -5.0F, -0.9017F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0784F, 1.76F, 0.5988F, 0.9599F, 0.0F, 0.0F));
		...
		PartDefinition neck_average_straight_long_2_top_mane = neck_average_straight_long_2_mane.addOrReplaceChild("neck_average_straight_long_2_top_mane", CubeListBuilder.create(), PartPose.offset(0.6201F, -2.4492F, -2.1375F));
		...
		PartDefinition cube_r8 = neck_average_straight_long_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(986, 932).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_straight_long_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(986, 939).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_straight_long_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(972, 933).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));

		PartDefinition neck_average_straight_long_2_bottom_mane = neck_average_straight_long_2_mane.addOrReplaceChild("neck_average_straight_long_2_bottom_mane", CubeListBuilder.create(), PartPose.offset(0.6201F, 0.4112F, -0.3498F));
		...
		PartDefinition cube_r11 = neck_average_straight_long_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(997, 928).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.7427F, -4.5417F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_straight_long_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(991, 941).addBox(-2.0F, -2.0F, 1.0F, 3.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -4.4641F, -4.957F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_straight_long_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(973, 934).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -2.6816F, -1.8771F, -0.9753F, -0.1144F, -0.1002F));
