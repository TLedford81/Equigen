...
public class neck_muscular_ewed_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_ewed_short_2(ModelPart root) {
		...
		this.withersAnchor = this.neck_muscular_ewed_short_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition withersAnchor = neck_muscular_ewed_short_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(-0.1F, -2.1346F, 1.2529F));
