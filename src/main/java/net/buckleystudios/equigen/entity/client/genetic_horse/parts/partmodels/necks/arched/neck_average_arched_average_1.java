...
public class neck_average_arched_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = neck_average_arched_average_1_crest_upper_individual.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(500, 619).addBox(-3.1434F, -5.8622F, -2.7188F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1434F, 0.8538F, 1.8426F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = neck_average_arched_average_1_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(809, 794).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0567F, 0.3652F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_average_arched_average_1_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(809, 801).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.5524F, 0.2999F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_arched_average_1_crest_lower.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(472, 619).addBox(-4.08F, -10.0F, -0.92F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 3.9457F, 3.8325F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_arched_average_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(823, 786).addBox(-2.0F, -2.0F, -2.01F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.3667F, -2.3092F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_arched_average_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(823, 797).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.0702F, -2.7119F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_arched_average_1_middle_individual.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(484, 619).addBox(-2.0F, -0.4682F, -0.3523F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0218F, -1.8182F, -4.4681F, 0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r14 = neck_average_arched_average_1_middle_individual.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(472, 606).addBox(-5.0F, -10.0F, -1.0F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5783F, 3.5644F, 3.1501F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r15 = neck_average_arched_average_1_lower_individual.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(490, 607).addBox(-5.08F, -7.7191F, -1.7991F, 5.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 3.6074F, 0.9268F, 0.3054F, 0.0F, 0.0F));
