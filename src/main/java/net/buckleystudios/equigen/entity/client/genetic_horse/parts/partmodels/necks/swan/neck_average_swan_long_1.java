...
public class neck_average_swan_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_swan_long_1(ModelPart root) {
		...
		this.headAnchor = this.neck_average_swan_long_1_crest_upper.getChild("headAnchor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_swan_long_1_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.1094F, -2.4642F, -4.1735F));
		...
		PartDefinition cube_r3 = neck_average_swan_long_1_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(595, 971).addBox(-4.08F, -12.0F, -0.92F, 4.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 6.1022F, 3.4307F, 0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_swan_long_1_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(577, 955).addBox(-4.0F, -10.0F, -2.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5055F, 3.0849F, 2.6281F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_average_swan_long_1_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(577, 971).addBox(-5.08F, -9.0F, -0.92F, 5.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5745F, 5.1222F, -0.6399F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_swan_long_1_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(597, 956).addBox(-5.0784F, -9.0F, -0.9017F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5784F, 3.6547F, -0.3147F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_swan_long_1_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(931, 970).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.9663F, 1.0647F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_swan_long_1_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(931, 978).addBox(-2.0F, -2.0F, -5.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.3759F, 0.7779F, -0.6109F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_swan_long_1_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(915, 972).addBox(-1.0707F, -0.1476F, -4.1526F, 1.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.4086F, 0.9511F, -0.4274F, -0.2133F, -0.3647F));
		...
		PartDefinition cube_r11 = neck_average_swan_long_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(941, 967).addBox(-2.0F, -2.0F, -1.01F, 2.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.9534F, -3.5267F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_swan_long_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(942, 980).addBox(-2.0F, -2.0F, -1.0F, 2.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -2.6569F, -3.9295F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_swan_long_1_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(918, 974).addBox(-0.8139F, -0.0002F, -4.3921F, 1.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5363F, -0.6257F, -0.0894F, -0.8937F, -0.1201F, -0.1036F));
