...
//
//
//public class head_straight_average<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "head_straight_average"), "main");
//	private final ModelPart head_straight_average;
//	private final ModelPart head_straight_average_forehead;
//	private final ModelPart head_straight_average_nose_bridge;
//	private final ModelPart head_straight_average_jaw;
//	private final ModelPart head_jaw_individual;
//	private final ModelPart head_jaw_branch;
//	private final ModelPart head_straight_average_fringe;
//	private final ModelPart head_straight_average_muzzle;
//	private final ModelPart head_straight_average_muzzle_individual;
//	private final ModelPart head_straight_average_mouth;
//
//	public head_straight_average(ModelPart root) {
//		this.head_straight_average = root.getChild("head_straight_average");
//		this.head_straight_average_forehead = this.head_straight_average.getChild("head_straight_average_forehead");
//		this.head_straight_average_nose_bridge = this.head_straight_average.getChild("head_straight_average_nose_bridge");
//		this.head_straight_average_jaw = this.head_straight_average.getChild("head_straight_average_jaw");
//		this.head_jaw_individual = this.head_straight_average_jaw.getChild("head_jaw_individual");
//		this.head_jaw_branch = this.head_straight_average_jaw.getChild("head_jaw_branch");
//		this.head_straight_average_fringe = this.head_straight_average.getChild("head_straight_average_fringe");
//		this.head_straight_average_muzzle = this.head_straight_average.getChild("head_straight_average_muzzle");
//		this.head_straight_average_muzzle_individual = this.head_straight_average_muzzle.getChild("head_straight_average_muzzle_individual");
//		this.head_straight_average_mouth = this.head_straight_average_muzzle.getChild("head_straight_average_mouth");
//	}
//
...
//		head_straight_average.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}