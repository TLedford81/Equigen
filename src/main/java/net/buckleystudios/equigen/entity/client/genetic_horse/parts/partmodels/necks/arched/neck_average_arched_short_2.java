...
public class neck_average_arched_short_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_arched_short_2(ModelPart root) {
		...
		this.headAnchor = this.neck_average_arched_short_2.getChild("headAnchor");
		this.chestAnchor = this.neck_average_arched_short_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_average_arched_short_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = neck_average_arched_short_2_middle_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(417, 606).addBox(-5.0F, -10.0F, -1.0F, 5.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5783F, 3.9827F, 3.3916F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_arched_short_2_top_mane_flow.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(753, 771).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0256F, -1.0516F, 0.0323F, 0.0399F, -0.3352F));
		...
		PartDefinition headAnchor = neck_average_arched_short_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.25F, -6.6327F, -6.1739F));
		...
		PartDefinition withersAnchor = neck_average_arched_short_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.2F, -0.8346F, 1.6529F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		neck_average_arched_short_2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
