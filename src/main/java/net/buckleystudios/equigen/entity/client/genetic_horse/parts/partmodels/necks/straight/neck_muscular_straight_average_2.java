...
public class neck_muscular_straight_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_muscular_straight_average_2(ModelPart root) {
		...
		this.headAnchor = this.neck_muscular_straight_average_2.getChild("headAnchor");
		this.chestAnchor = this.neck_muscular_straight_average_2.getChild("chestAnchor");
		this.withersAnchor = this.neck_muscular_straight_average_2.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = neck_muscular_straight_average_2_crest_lower.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(554, 892).addBox(-4.08F, -5.0F, -0.92F, 4.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 0.7064F, 1.3256F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_muscular_straight_average_2_bottom_mane_flow.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(863, 938).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -1.5195F, -0.8045F, -0.9753F, -0.1144F, -0.1002F));

		PartDefinition headAnchor = neck_muscular_straight_average_2.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(0.0F, -9.25F, -4.366F));
		...
		PartDefinition withersAnchor = neck_muscular_straight_average_2.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.1F, -0.5346F, 3.4529F));
