...
public class neck_average_straight_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_straight_average_1_crest_upper_individual.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offset(-0.0421F, 0.7398F, -3.5622F));
		...
		PartDefinition cube_r3 = neck_average_straight_average_1_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(823, 934).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_average_straight_average_1_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(822, 941).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_straight_average_1_top_mane_flow.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(808, 935).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r6 = neck_average_straight_average_1_crest_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(497, 864).addBox(-4.08F, -5.0F, -0.92F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 0.9177F, 1.7788F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck_average_straight_average_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(833, 935).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -3.514F, -3.6813F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_straight_average_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(830, 945).addBox(-2.0F, -2.0F, 1.0F, 3.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -3.2354F, -4.0966F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_straight_average_1_bottom_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(812, 939).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -1.5195F, -0.8045F, -0.9774F, -0.0927F, -0.1377F));
		...
		PartDefinition cube_r11 = neck_average_straight_average_1_middle_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(487, 852).addBox(-4.0F, -7.0F, -1.0F, 5.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4897F, 1.0357F, 2.9669F, 1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r12 = neck_average_straight_average_1_middle_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(467, 850).addBox(-2.5F, -4.5F, -2.5F, 5.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0103F, 1.1384F, -0.6706F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_straight_average_1_lower_individual.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(483, 864).addBox(-4.0784F, -5.0F, -0.9017F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 2.0468F, 1.0083F, 0.9599F, 0.0F, 0.0F));
