...
public class neck_average_straight_average_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public neck_average_straight_average_1(ModelPart root) {
		...
		this.withersAnchor = this.neck_average_straight_average_1.getChild("withersAnchor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r11 = neck_average_straight_average_1_bottom_mane_flow.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(812, 939).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -1.5195F, -0.8045F, -0.9774F, -0.0927F, -0.1377F));
		...
		PartDefinition withersAnchor = neck_average_straight_average_1.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.0F, -1.5346F, 2.9529F));
