...
public class neck_lean_straight_long_1 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = neck_lean_straight_long_1_top_mane_connector_individual.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(919, 919).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.616F, -0.933F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck_lean_straight_long_1_top_mane_connector2_individual.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(919, 926).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.049F, -1.183F, -0.5236F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_lean_straight_long_1_top_mane_flow.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(738, 894).addBox(-1.0707F, -0.1476F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3465F, -0.1867F, -0.3551F));
		...
		PartDefinition cube_r6 = neck_lean_straight_long_1_top_mane_flow_lower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(750, 894).addBox(-1.0707F, -0.1475F, -1.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -0.4463F, -0.7381F, -0.3812F, -0.0931F, -0.1081F));
		...
		PartDefinition cube_r7 = neck_lean_straight_long_1_crest_lower.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(613, 828).addBox(-3.08F, -5.0F, -0.92F, 3.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.58F, 0.4951F, 0.8725F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_lean_straight_long_1_bottom_mane_connector_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(932, 909).addBox(-2.0F, -2.0F, 0.99F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.3331F, -4.2549F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_lean_straight_long_1_bottom_mane_connector2_individual.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(933, 921).addBox(-2.0F, -2.0F, 1.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.0546F, -4.6702F, -0.9599F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = neck_lean_straight_long_1_bottom_mane_flow.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(918, 900).addBox(-0.8139F, -0.0002F, -2.3921F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8939F, -2.6816F, -1.8771F, -0.9753F, -0.1144F, -0.1002F));
		...
		PartDefinition cube_r13 = neck_lean_straight_long_1_middle_individual.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(585, 812).addBox(-4.0708F, -11.03F, -0.9292F, 4.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0811F, 5.8277F, 2.5752F, 0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r14 = neck_lean_straight_long_1_middle_individual.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(603, 814).addBox(-3.0F, -7.0F, -1.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.9897F, 0.6818F, 2.0413F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition cube_r15 = neck_lean_straight_long_1_lower_individual.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(599, 828).addBox(-4.0784F, -5.0F, -0.9017F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5784F, 1.7601F, 0.5988F, 0.9599F, 0.0F, 0.0F));
