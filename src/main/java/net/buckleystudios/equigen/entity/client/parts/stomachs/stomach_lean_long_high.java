...
//
//
//public class stomach_lean_long_high<T extends Entity> extends EntityModel<T> {
//	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "stomach_lean_long_high"), "main");
//	private final ModelPart stomach_lean_long_high;
//	private final ModelPart stomach_lean_long_high_stomach_front_upper;
//	private final ModelPart stomach_lean_long_high_stomach_front_upper_individual;
//	private final ModelPart stomach_lean_long_high_stomach_front_lower;
//	private final ModelPart stomach_lean_long_high_stomach_back_upper;
//	private final ModelPart stomach_lean_long_high_stomach_back_upper_individual;
//	private final ModelPart stomach_lean_long_high_stomach_back_lower;
//
//	public stomach_lean_long_high(ModelPart root) {
//		this.stomach_lean_long_high = root.getChild("stomach_lean_long_high");
//		this.stomach_lean_long_high_stomach_front_upper = this.stomach_lean_long_high.getChild("stomach_lean_long_high_stomach_front_upper");
//		this.stomach_lean_long_high_stomach_front_upper_individual = this.stomach_lean_long_high_stomach_front_upper.getChild("stomach_lean_long_high_stomach_front_upper_individual");
//		this.stomach_lean_long_high_stomach_front_lower = this.stomach_lean_long_high_stomach_front_upper.getChild("stomach_lean_long_high_stomach_front_lower");
//		this.stomach_lean_long_high_stomach_back_upper = this.stomach_lean_long_high.getChild("stomach_lean_long_high_stomach_back_upper");
//		this.stomach_lean_long_high_stomach_back_upper_individual = this.stomach_lean_long_high_stomach_back_upper.getChild("stomach_lean_long_high_stomach_back_upper_individual");
//		this.stomach_lean_long_high_stomach_back_lower = this.stomach_lean_long_high_stomach_back_upper.getChild("stomach_lean_long_high_stomach_back_lower");
//	}
//
...
//		stomach_lean_long_high.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
//	}
//}