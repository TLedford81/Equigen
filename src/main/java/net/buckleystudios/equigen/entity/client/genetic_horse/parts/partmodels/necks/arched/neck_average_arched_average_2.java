...
public class neck_average_arched_average_2 extends MultipartNeckModel<GeneticHorseEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headAnchor = neck_average_arched_average_2_crest_upper.addOrReplaceChild("headAnchor", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0221F, -0.0165F, -3.2926F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = neck_average_arched_average_2_crest_lower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(528, 619).addBox(-4.08F, -10.0F, -0.92F, 4.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.08F, 3.5921F, 3.479F, 0.7854F, 0.0F, 0.0F));

		PartDefinition withersAnchor = neck_average_arched_average_2_crest_lower.addOrReplaceChild("withersAnchor", CubeListBuilder.create(), PartPose.offset(0.0244F, 3.6301F, 2.9579F));

		PartDefinition cube_r4 = withersAnchor.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck_average_arched_average_2_middle_individual.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(540, 619).addBox(-5.0784F, -8.0F, -0.9017F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0002F, 5.7274F, 0.0236F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r6 = neck_average_arched_average_2_middle_individual.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(529, 605).addBox(-5.0F, -10.0F, -1.0F, 5.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5783F, 3.1462F, 2.9086F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r7 = neck_average_arched_average_2_lower_individual.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(547, 606).addBox(-5.08F, -7.7191F, -1.7991F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.58F, 3.1305F, 0.7764F, 0.3054F, 0.0F, 0.0F));

		PartDefinition neck_average_arched_average_2_mane = neck_average_arched_average_2.addOrReplaceChild("neck_average_arched_average_2_mane", CubeListBuilder.create(), PartPose.offset(0.0F, -7.0614F, -1.2514F));
		...
		PartDefinition cube_r8 = neck_average_arched_average_2_top_mane_connector_individual.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(871, 770).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.0567F, 0.3652F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = neck_average_arched_average_2_top_mane_connector2_individual.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(871, 777).addBox(-2.0F, -2.0F, -3.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 1.5524F, 0.2999F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = neck_average_arched_average_2_top_mane_flow.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(857, 771).addBox(-1.0707F, -0.1476F, -2.1526F, 1.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8045F, 0.0257F, -1.0516F, 0.0323F, 0.0399F, -0.3352F));
		...
		PartDefinition cube_r11 = neck_average_arched_average_2_bottom_mane_connector_individual.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(880, 767).addBox(-2.0F, -2.0F, -2.01F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.7634F, -2.6136F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r12 = neck_average_arched_average_2_bottom_mane_connector2_individual.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(881, 779).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.4669F, -3.0163F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition cube_r13 = neck_average_arched_average_2_bottom_mane_flow.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(859, 773).addBox(-0.8139F, -0.0002F, -5.3921F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0726F, 1.4302F, 1.2514F, -0.8937F, -0.1201F, -0.1036F));
