...
public enum Genetics {
    ...
    FACE_MARKING (ModData.FACE_MARKING, GeneticCategories.MARKING_GENETICS, 12, true, true),
    FRONT_LEFT_LEG_MARKING (ModData.FRONT_LEFT_LEG_MARKING, GeneticCategories.MARKING_GENETICS, 19, true, true),
    FRONT_RIGHT_LEG_MARKING (ModData.FRONT_RIGHT_LEG_MARKING, GeneticCategories.MARKING_GENETICS, 19, true, true),
    BACK_LEFT_LEG_MARKING (ModData.BACK_LEFT_LEG_MARKING, GeneticCategories.MARKING_GENETICS, 19, true, true),
    BACK_RIGHT_LEG_MARKING (ModData.BACK_RIGHT_LEG_MARKING, GeneticCategories.MARKING_GENETICS, 19, true, true),
